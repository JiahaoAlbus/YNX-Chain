...
.PHONY: bft-evm-receipt-check bft-evm-legacy-transfer-check bft-evm-access-list-transfer-check bft-ide-contract-check native-wallet-check chat-api-check square-api-check app-gateway-check app-account-ownership-check browser-signer-check mobile-check mobile-product-split-check mobile-android-native-check mobile-android-release-check mobile-android-release-installed-check mobile-biometric-installed-check asset-primitives-check
