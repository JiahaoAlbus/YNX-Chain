...
.PHONY: integration-coverage-refresh integration-coverage-refresh-check integration-acceptance-refresh integration-acceptance-check integration-release-acceptance-check integration-npm-audit-policy-check integration-npm-audit-policy-check-test integration-protect-preflight
...
integration-protect-preflight: integration-coverage-refresh-check integration-acceptance-check contract-tooling-check integration-npm-audit-policy-check integration-npm-audit-policy-check-test
	go test ./...
