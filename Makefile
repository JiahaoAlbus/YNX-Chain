...
.PHONY: explorer-portal-candidate-check explorer-i18n-check explorer-link-integrity-check
...
static-check:
	...
	node ./scripts/verify/explorer-link-integrity-check.mjs

explorer-i18n-check:
	node ./scripts/verify/explorer-i18n-check.mjs

explorer-link-integrity-check:
	node ./scripts/verify/explorer-link-integrity-check.mjs
