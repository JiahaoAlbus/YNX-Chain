...
caddy-ingress-check: chain-6423-ingress-source-check
caddy-ingress-check:
	bash ./scripts/deploy/dry-run.sh

chain-6423-ingress-source-check:
	bash ./scripts/verify/chain-6423-ingress-source-check.sh
