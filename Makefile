...
full-goal-coverage-check:
	node ./scripts/verify/full-goal-coverage-gate.mjs

document-metadata-check:
	node ./scripts/verify/document-metadata-gate.mjs --self-test
