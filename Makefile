...
.PHONY: upgrade-source-release-audit upgrade-source-release-evidence-check governance-check governance-testnet-drill monitor-deployment-check
...
testnet-endpoint-migration-check:
	...
	node --test ./scripts/verify/testnet-alias-preflight.test.mjs ./scripts/deploy/build-testnet-alias-package.test.mjs
...
monitor-deployment-check:
	bash ./scripts/verify/monitor-deployment-check.sh
...
faucet-alert-check:
	bash ./scripts/verify/faucet-alert-check.sh
