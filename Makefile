.PHONY: setup devnet dev env-check no-placeholder-check secret-scan objective-state-check readme-positioning-check deploy-readiness-gate deploy-readiness-gate-check deploy-connection-retry-check public-proof-evidence-check public-proof-package-check release-manifest-check release-manifest-evidence-check preflight test integration-test smoke-test remote-smoke-test deploy-testnet deploy-dry-run deploy-consensus-candidate consensus-candidate-deploy-gate verify-consensus-candidate consensus-candidate-key-ceremony consensus-overlay-key-ceremony deploy-consensus-overlay verify-consensus-overlay consensus-candidate-fault-drill consensus-candidate-signed-tx-drill consensus-candidate-rollback bft-gateway-check bft-ai-action-check bft-pay-action-check bft-trust-action-check bft-resource-action-check consensus-public-cutover-check consensus-public-cutover-gate public-bft-cutover-plan public-bft-cutover-transaction-check public-bft-production-rehearsal public-bft-production-rehearsal-check mutation-freeze-check replication-compression-check caddy-ingress-check verify-testnet verify-testnet-check host-key-audit host-key-repair-plan host-key-approval-check host-key-approval-status host-key-approval-template host-key-approval-request host-key-approval-packet host-key-approved-repair-dry-run host-key-approved-repair host-key-approval-check-test legacy-inventory remote-blocker-report status logs restart backup rollback docs grant-package ecosystem-package exchange-package mainnet-readiness wallet-integration-check chainlist-package exchange-integration-check developer-quickstart-check contract-tooling-check monitoring-check indexer-check explorer-check faucet-check ai-gateway-check pay-api-check trust-api-check resource-api-check resource-market-check validator-peer-readiness-check consensus-migration-check consensus-abci-check consensus-signed-transfer-check consensus-quorum-check consensus-production-package-check ops-check public-proof native-ynxt-no-hidden-freeze-check anti-illegal-request-check anti-unreasonable-tracking-check request-validity-check trust-appeal-check transparency-report-check emergency-action-policy-check privacy-safety-check
.PHONY: bft-evm-receipt-check bft-ide-contract-check
