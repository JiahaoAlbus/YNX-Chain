...
- Optional Envelope v2 `chainCommitmentId` consumes frozen Chain Core contract v1.29.0 / implementation `1571d6889b195daf476151474ce67889acdd9712` / contract `f0bc3c98d55976f33525ab6eed32403937b9b9c5` from the SHA-256-verified v29 bundle as a read-only external reference and fails closed before storage. Public semantics are unchanged; v29 retains the v28 validator lease and adds persist-before-sign ValidatorVoteSigner evidence with canonical proposal/validator checks, local returned-signature verification and fail-closed view consumption on signer failure. External signer custody is not claimed. The contract has 104 vectors and does not establish central integration or deployment.
