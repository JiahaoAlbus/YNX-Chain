...
- Optional Envelope v2 `chainCommitmentId` consumes frozen Chain Core contract v1.25.0 / implementation `503e06d06ca3f45eb189a5eafbfbf17c42df4fa6` / contract `8f385d975cd4e64d87fbb02b268e8d969e64d05c` from the SHA-256-verified v25 bundle as a read-only external reference and fails closed before storage. Public semantics are unchanged; v25 adds candidate-engine-only execution replay across 128 traces, 12,288 generated transactions and 2,048 executions plus 100 vectors. It does not establish CometBFT/public differential replay, central integration or deployment.
