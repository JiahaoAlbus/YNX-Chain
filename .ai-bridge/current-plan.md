...
- Optional Envelope v2 `chainCommitmentId` consumes frozen Chain Core contract v1.24.0 / implementation `f544eff9d20f9db3834d25b4a6f6737e367d1e0b` / contract `fef6c84e9bb30ebfc57f7a30123b4976096c9b61` from the SHA-256-verified v24 bundle as a read-only external reference and fails closed before storage. Bulk Data Commitment, v22 strategy-action and v23 reproducible-solc semantics are unchanged; v24 adds exact 4/7/13/21-validator quorum-intersection cardinality evidence and 99 vectors, not public deployment or full state-machine proof.
