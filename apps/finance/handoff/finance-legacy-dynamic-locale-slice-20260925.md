...
This slice adds 71 localized keys per language for source alerts, YNXT owned
...
validation states. These loaded sections re-render from the existing
account-bound data
...
Focused tests: locale completeness 378 keys across 12 languages, AI browser
