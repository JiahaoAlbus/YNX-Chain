...
## Product migration-evidence gate — 2026-08-21

Finance consumes the Wallet/Auth root export `evaluateProductWalletMigrationEvidence` from exact authority `e8125d56f8c28efbfa0f87c673717c620ca023e7` (tree `3e22e2854912eaec6f9f464e35d8c281f0957306`; module blob `c0ba159099c3040df9f4c2a25cef79cbcbf7cc08`, SHA-256 `dac1e57bf989e5ad9e63c568df3c2eb9af7b154501b21f7cf182194a35af694e`) through the hash-pinned archive `web/vendor/ynx-chain-wallet-auth-1.0.0-product-migration-evidence-p0.tgz` (SHA-256 `8ae596ab4099123b55d273698704bfe1150e571328b08dd6e50dd8bb3d658d6e`). The evaluator input binds the accepted shared source to `98c6d5d784d212df8981a53b17118a511e246ad2` / complete tree `51a60a362d4ad5dd748bcdefb101f71b1d9e0cee` / evidence `c3ab255c32bdeb9c8e056882c315f8ad43c29c7f`, never the distinct `69ba…` package subtree.

The exact evaluator result is source accepted but `productsConnected=0` and `migratedV2=false`: public runtime binding, visible Standard Wallet lifecycle, exact approve/reject callback with cold-start recovery, and the complete Product Session lifecycle remain unproven. The gate is evidence-evaluation-only; it does not create a session, request an account, or promote any release state. See [p0-finance-product-wallet-migration-evidence-20260821.json](evidence/p0-finance-product-wallet-migration-evidence-20260821.json) and run `npm run verify:migration-evidence --prefix apps/finance/web`.
