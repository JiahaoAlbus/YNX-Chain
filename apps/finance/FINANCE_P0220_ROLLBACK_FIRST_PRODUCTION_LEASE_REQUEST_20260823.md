...
The corrected executor is `apps/finance/scripts/finance-production-rollback-first.sh`, 6,591 bytes, SHA-256 `80c9884f1e935406173f9dc39032a4f5b4c1c7282b46e82b3e7becd15c212aec`; its static safety regression is `apps/finance/scripts/test-finance-production-command-object.mjs`, 765 bytes, SHA-256 `f6070187bac95cbeca1a4058db304d60150243d57a79b8b226019491de842af9`. Future Central lease input must be absolute under `/opt/ynx/leases/finance/`, signed, and include every field used by this object: HTTP status/bytes/body-SHA for all old and candidate endpoint/asset reads, state absence or exact tuple/bytes/SHA, service PID/NRestarts, and lease-specific parent tuple/path contracts.
