...
The corrected executor is `apps/finance/scripts/finance-production-rollback-first.sh`, 7,940 bytes, SHA-256 `a222701b62b0d8843f893b35b0b17159113d8089bf95f3ae4f70580867b9d5d9`; static contract regression is `apps/finance/scripts/test-finance-production-command-object.mjs`, 870 bytes, SHA-256 `1c8cd0c787f0632540264fc68f80eb1b9921c1b3848d71a8c762dcd07952c6fc`; dynamic fixture `apps/finance/scripts/test-finance-production-fixture.mjs` is 7,067 bytes, SHA-256 `b1cd3d45515369fbeea075341d2e6923fedff794bf5413f1eb0f283c6b5dadb5`. Receipt objects remain `{url,status,bytes,sha256}`. The fixture executes hermetic candidate-switch success and forced candidate-verifier rollback with named curl/systemctl/file/readlink stubs; it also rejects traversal, state symlink, HTTP status/bytes and asset mismatches. Candidate PID must be numeric and differ from signed old PID, while NRestarts must increment exactly once. State restoration captures candidate regular-file tuple and digest after stopping, then uses same-parent atomic replacement and validates a restored tuple that intentionally excludes the historical inode.
