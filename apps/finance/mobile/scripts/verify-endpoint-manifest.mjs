...
const manifest=JSON.parse(await readFile(new URL('../contract/public-endpoint-manifest.json',import.meta.url),'utf8'));
const expected='3c606cad1d9bfa71fc507f54b6ad8184a6580c7df75440675b5db921b7e67bb5',payload={...manifest};delete payload.integrity;
...
const issuedAt=Date.parse(manifest.issuedAt),expiresAt=Date.parse(manifest.expiresAt);
