...
export type Settings={locale:string;aiLocale:string;apiBase:string};
const SETTINGS='ynx.finance.settings.v1',CACHE='ynx.finance.offline.v1',TOKEN='ynx.finance.session.v1';
export const defaultSettings:Settings={locale:'system',aiLocale:'en',apiBase:'http://10.0.2.2:8787'};
