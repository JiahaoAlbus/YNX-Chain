...
const publicFinanceApi=(process.env.EXPO_PUBLIC_YNX_FINANCE_API_URL||'https://finance.ynxweb4.com').replace(/\/$/,'');
export const defaultSettings:Settings={locale:'system',aiLocale:'en',apiBase:publicFinanceApi,theme:'system'};
