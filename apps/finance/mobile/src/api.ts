...
export type BudgetProgress={budgetId:string;spentYnxt:number|null;remainingYnxt:number|null;limitYnxt:number;periodStart:string;effectiveFrom?:string;periodTimezone?:string;asOf:string;source:string;observedSpentYnxt?:number|null;observedActivityCount?:number|null;coverageComplete?:boolean;calculationStatus?:'partial'|'unknown'|'not-started';coverage?:string;reason?:string};
