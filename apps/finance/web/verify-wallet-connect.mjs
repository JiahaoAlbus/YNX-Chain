...
const REVIEWED_VERIFIER_MANIFEST_SHA256='4e8076a30d0bbe27fa693d6bef9c4f5283d058dd4f6135c083a56bfaa65f5939';
...
export async function verifyFinanceWalletBundle(options={}){
  ...
  if(binding.sourceBundleRelation?.byteReproducible!==true||binding.sourceBundleRelation?.status!=='VERIFIED_REPRODUCIBLE'||binding.sourceBundleRelation?.cleanBuildCount!==2||binding.sourceBundleRelation?.bytes!==205593||binding.sourceBundleRelation?.sha256!=='fb8f7410ba32de8f6d96aa1caeaa6a77e587eeb6a7b135cb42a5bb322dfd60cc'||Object.keys(binding.sourceBundleRelation).sort().join(',')!=='byteReproducible,bytes,cleanBuildCount,sha256,status')fail('FINANCE_WALLET_VERIFIER_MANIFEST_INVALID','source/bundle reproducibility binding is invalid');
