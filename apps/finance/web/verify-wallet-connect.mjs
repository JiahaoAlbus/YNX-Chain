...
const REVIEWED_VERIFIER_MANIFEST_SHA256='ab1f2c5cc01bea1d893ef89e6c954efa60d1a0ad229c5bc49b5d6b0ed1b60a37';
...
export async function verifyFinanceWalletBundle(options={}){
  ...
  if(binding.sourceBundleRelation?.byteReproducible!==true||binding.sourceBundleRelation?.status!=='VERIFIED_REPRODUCIBLE'||binding.sourceBundleRelation?.cleanBuildCount!==2||binding.sourceBundleRelation?.bytes!==205623||binding.sourceBundleRelation?.sha256!=='1053a255f6e458e08444643e5509350b56e9bb65b3a0b4138637961a8df20d55'||Object.keys(binding.sourceBundleRelation).sort().join(',')!=='byteReproducible,bytes,cleanBuildCount,sha256,status')fail('FINANCE_WALLET_VERIFIER_MANIFEST_INVALID','source/bundle reproducibility binding is invalid');
