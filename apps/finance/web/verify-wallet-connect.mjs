...
for(const marker of ['launchWebAuthorization','@ynx-chain/wallet-auth/src/authorize-launcher.js','eth_requestAccounts','eth_chainId','wallet_switchEthereumChain','wallet_addEthereumChain','YNX_CHAIN_HEX'])if(!entry.includes(marker))throw new Error(`Missing provider-only Wallet control: ${marker}`);
