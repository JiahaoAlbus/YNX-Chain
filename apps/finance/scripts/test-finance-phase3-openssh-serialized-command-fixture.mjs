...
{const x=make();x.args[7]='wrong-phase3-namespace';const r=run(x);assert.equal(r.status,65);assert.equal(existsSync(x.counter),false,'wrong transport namespace must not reach SSH');rmSync(x.root,{recursive:true,force:true});}
