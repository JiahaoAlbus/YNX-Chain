...
function crossStagePhase3Fixture() {
  ...
  assert.ok(result.stdout.includes('phase=3') && result.stdout.includes(`lease=${join(leasesParent, 'finance', `${id}.json`)}`), 'exact bootstrap invokes real executor');
