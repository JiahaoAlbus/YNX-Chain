...
execute(false); execute(true, { candidateState: 'file' }); execute(true, { absent: true, candidateState: 'file' }); execute(true, { absent: true, candidateState: 'symlink' }); execute(true, { absent: true, candidateState: 'file', substitute: true }); execute(true, { envMismatch: true }); serviceTraversalFixture(true); serviceTraversalFixture(false); releaseContainerFixture('missing-parent'); releaseContainerFixture('foreign'); releaseContainerFixture('symlink'); releaseContainerFixture('cleanup'); releaseContainerFixture('substitution'); releasePostMoveSubstitutionFixture(); manualRollbackFixture(); manualRollbackFixture('foreign'); manualRollbackFixture('substitution'); generatorNegative('missing'); generatorNegative('duplicate'); phase1Fixture(); preparationFixture(); crossStagePhase3Fixture(); console.log('finance production actual-shell fixture: pass');
