...
const candidatePath=resolve(financeRoot,'evidence/wallet-verifier-manifest-workspace-9204e843-v7-20260925.json');
const sourceCheckpoint='9204e84304f5bb088db3012c63c654b061b12622';
...
const reviewedChanges=new Map([
  ...
  ['app.js',{bytes:66989,sha256:'8deba27c0c1d2b2e0b3edabeed5141bdd5fb6b5d32cd16bba1f0b30284a17c3f'}],
...
assert.deepEqual(changed.sort(),[...reviewedChanges.keys()].sort());
