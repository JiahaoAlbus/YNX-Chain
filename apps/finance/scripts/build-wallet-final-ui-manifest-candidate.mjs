...
const prior=execFileSync('git',['show','01130b501da5c16fce41c547feabf9b7c10cd3f0:apps/finance/web/wallet-verifier-manifest.json'],{cwd:repoRoot});
...
const candidatePath='../evidence/evm-read-runtime-verifier-candidate-final-ui-01130b50-v4-20260925.json';
const candidateBytes=readFileSync(resolve(root,candidatePath));
const candidateSha256='9568598e9a098b2cfdf7bf6b133db25a28cc4006079f65d25d2349c052cc4286';
...
const output='../evidence/wallet-verifier-manifest-final-ui-01130b50-v5-20260925.json';
