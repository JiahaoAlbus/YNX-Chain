...
```text
ssh <signed-host> sudo -n /bin/bash -c 'boot=$(printf %s "$1" | base64 -d); shift; /bin/bash -c "$boot" phase2a "$@"' phase2a <BOOTSTRAP_BASE64> p0228-finance-phase1-20260822T234100Z /opt/ynx/stage/finance/p0228-finance-phase1-20260822T234100Z <rootTuple> <stageParentTuple> <stageTuple> <leasesParentTuple> <leaseParentTuple> <carrierTuple>
```
