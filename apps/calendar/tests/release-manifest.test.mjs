...
const centralRelease = readJSON("../../../release/calendar/product-release.json");
const publicMetadata = readJSON("../../../release/calendar/public-product-metadata.json");
const integrationContract = readJSON("../../../release/integration/calendar-contract.json");
const testVectors = readJSON("../../../release/calendar/cross-product-test-vectors.json");
const coverage = readJSON("../../../release/calendar/full-goal-coverage.json");
...
test("current source and historical preview artifacts remain separated", () => {
  ...
  assert.equal(centralRelease.sourceCommit, release.commit);
  assert.equal(centralRelease.releaseStates.installedLocal, false);
