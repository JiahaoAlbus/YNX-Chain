...
export interface OpsState { incidents:Incident[]; alerts:Alert[]; audits:AuditEvent[]; rollbackProposals:Array<Record<string,unknown>>; backupRecords:Array<Record<string,unknown>>; walletChallenges:WalletChallenge[] }
