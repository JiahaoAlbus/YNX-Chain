...
| macOS and Windows downloads | Historical unsigned artifacts have hashes and cold-launch evidence | historical only | Current-source immutable hosted artifacts and new install proof |
