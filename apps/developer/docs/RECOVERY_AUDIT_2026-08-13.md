...
- Language service: 9 passed, 2 skipped (`gopls` and `rust-analyzer` absent), including real C completion and diagnostics through clangd with the C language identifier.
