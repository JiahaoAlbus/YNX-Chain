...
| LSP and Problems | Bounded language-service bridge plus content-bound navigable Problems records | 8 passed: C++, Python, Solidity and TypeScript completion/definition/diagnostics; Problems renders real severity/location/source/code and rejects stale-content entries | `gopls` and `rust-analyzer` skipped because reviewed binaries are absent; Java LSP, unopened-file whole-project diagnostics and formatting/rename/reference acceptance remain open |
