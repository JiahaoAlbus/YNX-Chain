...
| Web/PWA | React/TypeScript/Monaco workbench behind same-origin gateway with real persisted editor settings | Settings now control Monaco font/minimap/wrap and revision-safe auto/manual save; frontend and protocol TypeScript checks plus gateway 2/2 passed | Re-run browser E2E/current accessibility against the current release service |
