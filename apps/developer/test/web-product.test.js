...
test("Windows proof requires a real Windows build, MSIX installation and cold launch",async()=>{
  ...
  assert.match(packageScript,/build-provenance\.json/);assert.match(packageScript,/sbom\.cdx\.json/);assert.match(packageScript,/SignTool\.exe/);assert.match(packageScript,/unsigned-no-authenticode/);
