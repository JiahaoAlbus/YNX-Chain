...
for (const required of ["#002FA7", "ynx_6423-1", "0.8.24", "Wallet", "source match", "YNX AI Build", "diagnostics", "checkpoint", "RPC Tools", "locale-select", "ai-language", "app-gateway", "Artifact Center", "Command Palette"]) {
