...
test("Search controlled launcher never navigates the top-level page",async()=>{
  const topLevel={href:"https://web4.ynxweb4.com/search/"},environment=dom();
  ...
  assert.equal(topLevel.href,"https://web4.ynxweb4.com/search/");
