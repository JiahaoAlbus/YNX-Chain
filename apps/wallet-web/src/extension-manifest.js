...
const sharedManifest = {
  ...
  content_scripts: [
    {matches:["http://*/*","https://*/*"],js:["content-script.js"],run_at:"document_start",all_frames:false,match_about_blank:false},
    {matches:["http://*/*","https://*/*"],js:["page-provider.js"],run_at:"document_start",all_frames:false,match_about_blank:false,world:"MAIN"},
  ],
