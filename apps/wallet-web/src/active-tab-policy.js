function reject(){throw Object.assign(new Error("Open an HTTPS DApp tab and invoke the extension action first."),{code:"ACTIVE_TAB_REQUIRED"})}
...
export function requireActiveDappTab(tab){
  ...
  if(url.protocol!=="https:"||url.username||url.password)reject();
