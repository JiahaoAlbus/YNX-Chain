...
execFileSync(process.execPath, ["--test", "test/i18n.test.js", "test/provider.test.js", "test/ui-contract.test.js", "test/preferences.test.js", "test/service-worker-policy.test.js", "test/active-tab-policy.test.js", "test/extension-manifest.test.js", "test/extension-bridge.test.js", "test/extension-rpc.test.js", "test/extension-sensitive-policy.test.js", "test/extension-migration.test.js", "test/wallet-web-companion-lifecycle.test.js"], {cwd:root, stdio:"inherit"});
