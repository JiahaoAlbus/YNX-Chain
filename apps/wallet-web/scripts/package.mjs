...
execFileSync(process.execPath, ["--test", "test/i18n.test.js", "test/provider.test.js", "test/ui-contract.test.js", "test/extension-manifest.test.js"], {cwd:root, stdio:"inherit"});
