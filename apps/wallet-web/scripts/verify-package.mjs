...
for (const artifact of manifest.artifacts) {
  ...
  if (artifact.browsers.includes("PWA")) {
    for (const required of ["manifest.webmanifest", "preferences.js", "mobile-wallet-routing.js", "core-auth-consumer.js", "wallet-web-companion-lifecycle.js", "core-auth-binding.js", "sw.js", "sw-v7.js", "service-worker-policy.js", "asset-integrity.js", "pwa-upgrade.html", "pwa-upgrade.js", "ynx-icon-192.png", "ynx-icon-512.png", "ynx-icon-maskable-512.png"]) if (!entries.includes(required)) throw new Error(`Missing ${required}: ${artifact.name}`);
