...
const artifact=await readFile(join(root,"artifacts/ynx-wallet-firefox-0.1.1.zip"));
...
const evidence={
  ...
  artifact:{name:"ynx-wallet-firefox-0.1.1.zip",bytes:artifact.length,sha256:createHash("sha256").update(artifact).digest("hex"),signingClass:"unsigned-unpacked-extension"},
