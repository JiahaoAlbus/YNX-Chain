(() => {
  ...
  const METHODS=new Set(["eth_chainId","eth_accounts","eth_requestAccounts","wallet_addEthereumChain","wallet_switchEthereumChain","wallet_requestPermissions","wallet_getPermissions","wallet_revokePermissions","wallet_watchAsset","personal_sign","eth_signTypedData_v4","eth_sendTransaction","ynx_disconnect"]),EVENTS=new Set(["accountsChanged","chainChanged","disconnect"]),pending=new Map(),listeners=new Map();
  ...
  const provider=Object.freeze({
    ...
    providerInfo:Object.freeze({uuid:"6f4e2a77-7878-4f29-9c0d-191700000001",name:"YNX Wallet",icon:"data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg'/>",rdns:"com.ynx.wallet.companion"}),
