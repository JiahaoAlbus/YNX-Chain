...
const SHELL=['','styles.css','workflow.css','app.js','i18n.js','wallet-auth.js','manifest.webmanifest','icon-192.png','icon-512.png','metamask-fox.svg'].map(path=>new URL(path,self.registration.scope).pathname);
