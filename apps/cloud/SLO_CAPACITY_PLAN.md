...
Persistent local RED histograms use normalized route templates and fixed bounds of 10/50/100/250/500/1000/2500/5000 ms plus overflow. The local dashboard warns on bounded-histogram p95 above 1000 ms after 20 observations and alerts on error rate above 5%; these are diagnostic thresholds, not proof of the candidate staging SLO. Provider child latency and multi-replica aggregation remain absent.
