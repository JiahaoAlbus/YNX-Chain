...
| Quota and audit | yes | local | service tests and canonical smoke | billing provider |
...
| Presigned direct upload | no | no | none | reviewed S3-compatible adapter |
...
| Export/delete | partial | local delete | delete tests | portable archive + account export |
