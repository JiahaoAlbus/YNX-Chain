...
Evidence baseline: source commit `76f5c92cee7f5105f9e84059d0ae8fed75337e2c`; lifecycle Runtime is pinned separately to `d11c382da10ab0629c7d322c83c9ddef24925328`. GitHub Actions run `30279314603` verifies the exact source's security/recovery workflow, least-privilege image cold-start, configured Critical/High vulnerability gate and retained JSON report; staging, public deployment, immutable hosted artifacts, reproducible provenance and production signing remain separately unproven.
...
| Security and supply chain | partial | local + exact-SHA CI | threat model, security boundaries, deterministic 468-component CycloneDX inventory, script allowlist, Go vet/secret/lock/artifact gate, local APK provenance record, `evidence/CONTAINER_SCAN_76f5c92.json`, and GitHub Actions run `30279314603`; Trivy 0.70.0 reported zero configured-scope Critical/High OS/library findings and retained Artifact `8658138768` | external SAST/DAST/penetration report, immutable image publication, continuous monitoring, reproducible published artifact, production attestation/signing |
