...
test("formal Wallet request deep link and P-256 proof are deterministic",()=>{
  ...
  const challenge={version:"1",challenge:"gateway_challenge_abcdefghijklmnop",requestDigest:"8af8ac0dd31e2aa874ef95d9c22c1aae25d1f42bf661b0427c9553aecc7f701d",productClientId:"ynx-social-v1",bundleId:"com.ynxweb4.social",productDeviceAlgorithm:"p256-sha256",productDeviceKey:identity.publicKey,account:"ynx10e0525sfrf53yh2aljmm3sn9jq5njk7llqhn80",scopes:["account:read","profile:link"],issuedAt:"2026-07-15T12:00:00.000Z",expiresAt:"2026-07-15T12:03:00.000Z"};
