...
(async()=>{
 ...
 try{
  ...
  console.log(JSON.stringify({product:"ai",guestDesktop:true,guestMobile:true,standardWalletConnected:true,privateProductSession:"DEGRADED",consoleErrors:0,computerControl:false}));
