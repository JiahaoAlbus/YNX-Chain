...
- `sbom.cdx.json`, `scripts/sbom-check.mjs` and `proof/wallet-sbom-release-grade-2026-07-27.json`: pinned CycloneDX npm 6.0.0 produces a deterministic CycloneDX 1.6 runtime graph with 431 components, 504 dependency nodes, complete license metadata and SHA-256 `7d1afd4f176776840a45c131843cde1550154f738a1e3da67f1163cf88dab633`; generation and verification reject npm tree errors, stale output, duplicate references and missing licenses.
