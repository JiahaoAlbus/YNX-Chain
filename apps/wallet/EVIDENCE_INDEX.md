...
- `proof/gateway-public-probe-blocked-2026-08-13.json`: the explicit opt-in public lifecycle probe at source `652b9da67a47e13f1826db07d423d464100939c1` failed closed after two bounded connection attempts with `UND_ERR_CONNECT_TIMEOUT` before any HTTP response. Separate HEAD requests resolved the three public lifecycle routes and returned 405, which proves route presence only. No fresh completion, introspection, replay, revoke or post-revoke success is claimed.
