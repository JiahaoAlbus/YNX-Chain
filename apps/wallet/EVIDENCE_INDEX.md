...
- `sbom.cdx.json`, `scripts/sbom-check.mjs` and `proof/wallet-sbom-1.0.1-local-2026-08-14.json`: pinned CycloneDX npm 6.0.0 produces the current deterministic Wallet 1.0.1 CycloneDX 1.6 runtime graph with 431 components, 504 dependency nodes, complete license metadata and SHA-256 `4d9a8d93de710755e97c55ae2cad15769992ed3718d3f75e752036ffbbec1d67`; generation and verification reject package-version drift, npm tree errors, stale output, duplicate references and missing licenses. `proof/wallet-sbom-release-grade-2026-07-29.json` and `release/evidence/wallet-auth-source-candidate-2026-07-29.json` preserve the earlier 1.0.0 source-candidate evidence.
