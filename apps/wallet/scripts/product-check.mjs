...
assert.ok(source.includes('const handleLink=useCallback((url:string)=>{\n    cancelLocalKeyAuthorization();try{assertDeepLinkForeground'),"a replacement deep link must cancel any in-flight biometric before parsing or replacing its review");
