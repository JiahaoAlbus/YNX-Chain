...
for(const required of ["parseExchangeOrderActionDeepLink","Review Exchange order","Approve and return to Exchange","No withdrawal, transfer, market order, reusable mandate or unlimited approval is included."])assert.equal(source.includes(required),true,`missing Exchange action boundary ${required}`);
