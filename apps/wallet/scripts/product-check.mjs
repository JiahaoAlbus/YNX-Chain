...
for(const file of ["../../../packages/wallet-auth/integration/gateway-integration.manifest.json","../../../packages/wallet-auth/integration/gateway-state.schema.json","../../../packages/wallet-auth/integration/smart-account-testnet.manifest.json","../../../packages/wallet-auth/testdata/product-session-http-proof-v1.json","../proof/gateway-benchmark-local.json","../proof/smart-account-hardhat-local.json","../proof/sponsorship-bundler-hardhat-local.json"])await access(new URL(file,import.meta.url));
