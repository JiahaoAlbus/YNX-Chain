...
export type AuthorizationPurpose = "unlock" | "wallet-authorization" | "transaction-sign" | "recovery-view" | "account-import" | "account-delete" | "wallet-sessions-view" | "wallet-session-revoke";
