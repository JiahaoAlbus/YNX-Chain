...
export type AuthorizationPurpose = "unlock" | "wallet-authorization" | "exchange-order" | "dex-transaction" | "developer-contract-deployment" | "transaction-sign" | "recovery-view" | "account-import" | "account-delete";
