...
export type AuthorizationPurpose = "unlock" | "wallet-authorization" | "transaction-sign" | "faucet-request" | "recovery-view" | "account-import" | "account-delete";
...
const prompts: Record<AuthorizationPurpose, string> = {
  ...
  "faucet-request": "Request test YNXT for this Wallet account",
