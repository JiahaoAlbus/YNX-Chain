...
test("Wallet locally reviews the exact approved finance, commerce and existing bounded tuples",()=>{
  assert.deepEqual(Object.keys(PRODUCT_REGISTRY).sort(),["ynx-card-v1","ynx-dex-web-v1","ynx-exchange-v1","ynx-finance-v1","ynx-pay-v1","ynx-quant-v1","ynx-shop-v1","ynx-social-v1"]);
  ...
  assert.equal(PRODUCT_REGISTRY["ynx-dex-web-v1"]?.callbacks[0],"https://dex.ynxweb4.com/wallet-auth/callback");
