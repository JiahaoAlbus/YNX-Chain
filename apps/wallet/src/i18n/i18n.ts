...
const UI_EN={welcome:"WELCOME · SELF-CUSTODY STARTS HERE",ownAccount:"Own your account.",recoverReplacement:"Recover on a replacement device",beforeBegin:"Before you begin",walletLocked:"WALLET LOCKED",checkingBiometrics:"Checking biometrics…",lostDeviceRecovery:"Lost-device recovery",nativeAccount:"NATIVE ACCOUNT",send:"Send",receive:"Receive",activity:"Activity",accountSafety:"Account safety",lockWallet:"Lock Wallet",createAnother:"Create another account",importAnother:"Import recovery key",authorizationLead:"Review every binding. Approval shares a public account proof only.",aiSecurity:"AI security explanation",aiCannotApprove:"AI cannot sign or approve.",removeAccountFromDevice:"Remove account from this device",removeAccountTitle:"Remove account?",removeAccountWarning:"This permanently removes local key material and revokes its availability in Wallet. It does not erase chain history. Recovery requires the offline key.",typeAccountLabelToConfirm:"Type {label} to confirm",removeLocalAccount:"Remove local account"} as const;
...
const UI_MESSAGES:Record<WalletLocale,Record<UIMessageKey,string>>={
  en:UI_EN,
  "zh-Hans":{welcome:"欢迎 · 自托管从这里开始",ownAccount:"掌控你的账户。",recoverReplacement:"在替换设备上恢复",beforeBegin:"开始之前",walletLocked:"钱包已锁定",checkingBiometrics:"正在检查生物识别…",lostDeviceRecovery:"丢失设备恢复",nativeAccount:"原生账户",send:"发送",receive:"接收",activity:"活动",accountSafety:"账户安全",lockWallet:"锁定钱包",createAnother:"创建另一个账户",importAnother:"导入恢复密钥",authorizationLead:"逐项检查绑定。批准只会共享公开账户证明。",aiSecurity:"AI 安全说明",aiCannotApprove:"AI 无法签名或批准。",removeAccountFromDevice:"从此设备移除账户",removeAccountTitle:"移除账户？",removeAccountWarning:"这会永久移除本地密钥材料，并使该账户无法在 Wallet 中使用。链上历史不会被删除。恢复账户需要离线恢复密钥。",typeAccountLabelToConfirm:"输入 {label} 以确认",removeLocalAccount:"移除本地账户"},
  "zh-Hant":{welcome:"歡迎 · 自我託管從這裡開始",ownAccount:"掌控你的帳戶。",recoverReplacement:"在替換裝置上復原",beforeBegin:"開始之前",walletLocked:"錢包已鎖定",checkingBiometrics:"正在檢查生物辨識…",lostDeviceRecovery:"遺失裝置復原",nativeAccount:"原生帳戶",send:"傳送",receive:"接收",activity:"活動",accountSafety:"帳戶安全",lockWallet:"鎖定錢包",createAnother:"建立另一個帳戶",importAnother:"匯入復原金鑰",authorizationLead:"逐項檢查綁定。核准只會分享公開帳戶證明。",aiSecurity:"AI 安全說明",aiCannotApprove:"AI 無法簽署或核准。",removeAccountFromDevice:"從此裝置移除帳戶",removeAccountTitle:"移除帳戶？",removeAccountWarning:"這會永久移除本機的金鑰資料，並使此帳戶無法在 Wallet 中使用。鏈上歷史不會被刪除。復原帳戶需要離線復原金鑰。",typeAccountLabelToConfirm:"輸入 {label} 以確認",removeLocalAccount:"移除本機帳戶"},
  ja:{welcome:"ようこそ · セルフカストディはここから",ownAccount:"自分のアカウントを管理。",recoverReplacement:"交換端末で復元",beforeBegin:"始める前に",walletLocked:"ウォレットはロック中",checkingBiometrics:"生体認証を確認中…",lostDeviceRecovery:"紛失端末から復元",nativeAccount:"ネイティブアカウント",send:"送信",receive:"受取",activity:"履歴",accountSafety:"アカウントの安全",lockWallet:"ウォレットをロック",createAnother:"別のアカウントを作成",importAnother:"復元キーをインポート",authorizationLead:"すべての紐付けを確認してください。承認で共有するのは公開アカウント証明だけです。",aiSecurity:"AI セキュリティ説明",aiCannotApprove:"AI は署名も承認もできません。",removeAccountFromDevice:"この端末からアカウントを削除",removeAccountTitle:"アカウントを削除しますか？",removeAccountWarning:"端末内の鍵情報を完全に削除し、このアカウントを Wallet で利用できなくします。チェーン上の履歴は削除されません。復元にはオフラインで保管した復元キーが必要です。",typeAccountLabelToConfirm:"確認のため {label} と入力",removeLocalAccount:"端末内のアカウントを削除"},
  ko:{welcome:"환영합니다 · 셀프 커스터디 시작",ownAccount:"내 계정을 직접 관리하세요.",recoverReplacement:"교체 기기에서 복구",beforeBegin:"시작하기 전에",walletLocked:"지갑 잠김",checkingBiometrics:"생체 인증 확인 중…",lostDeviceRecovery:"분실 기기 복구",nativeAccount:"네이티브 계정",send:"보내기",receive:"받기",activity:"활동",accountSafety:"계정 안전",lockWallet:"지갑 잠그기",createAnother:"다른 계정 만들기",importAnother:"복구 키 가져오기",authorizationLead:"모든 바인딩을 확인하세요. 승인은 공개 계정 증명만 공유합니다.",aiSecurity:"AI 보안 설명",aiCannotApprove:"AI는 서명하거나 승인할 수 없습니다.",removeAccountFromDevice:"이 기기에서 계정 제거",removeAccountTitle:"계정을 제거할까요?",removeAccountWarning:"이 기기에 저장된 키 자료가 영구적으로 제거되어 Wallet에서 이 계정을 사용할 수 없게 됩니다. 체인 기록은 삭제되지 않습니다. 복구하려면 오프라인으로 보관한 복구 키가 필요합니다.",typeAccountLabelToConfirm:"확인하려면 {label} 입력",removeLocalAccount:"로컬 계정 제거"},
  es:{welcome:"BIENVENIDA · TU AUTOCUSTODIA EMPIEZA AQUÍ",ownAccount:"Controla tu cuenta.",recoverReplacement:"Recuperar en otro dispositivo",beforeBegin:"Antes de empezar",walletLocked:"WALLET BLOQUEADA",checkingBiometrics:"Comprobando biometría…",lostDeviceRecovery:"Recuperación por dispositivo perdido",nativeAccount:"CUENTA NATIVA",send:"Enviar",receive:"Recibir",activity:"Actividad",accountSafety:"Seguridad de la cuenta",lockWallet:"Bloquear Wallet",createAnother:"Crear otra cuenta",importAnother:"Importar clave de recuperación",authorizationLead:"Revisa cada vínculo. La aprobación solo comparte una prueba pública de la cuenta.",aiSecurity:"Explicación de seguridad con IA",aiCannotApprove:"La IA no puede firmar ni aprobar.",removeAccountFromDevice:"Eliminar cuenta de este dispositivo",removeAccountTitle:"¿Eliminar cuenta?",removeAccountWarning:"Esto elimina permanentemente el material de claves local e impide usar esta cuenta en Wallet. No borra el historial de la cadena. Para recuperarla necesitas la clave de recuperación guardada sin conexión.",typeAccountLabelToConfirm:"Escribe {label} para confirmar",removeLocalAccount:"Eliminar cuenta local"},
  fr:{welcome:"BIENVENUE · L’AUTOGARDE COMMENCE ICI",ownAccount:"Gardez le contrôle de votre compte.",recoverReplacement:"Restaurer sur un appareil de remplacement",beforeBegin:"Avant de commencer",walletLocked:"WALLET VERROUILLÉ",checkingBiometrics:"Vérification biométrique…",lostDeviceRecovery:"Récupération après perte de l’appareil",nativeAccount:"COMPTE NATIF",send:"Envoyer",receive:"Recevoir",activity:"Activité",accountSafety:"Sécurité du compte",lockWallet:"Verrouiller Wallet",createAnother:"Créer un autre compte",importAnother:"Importer la clé de récupération",authorizationLead:"Vérifiez chaque liaison. L’approbation ne partage qu’une preuve publique du compte.",aiSecurity:"Explication de sécurité par IA",aiCannotApprove:"L’IA ne peut ni signer ni approuver.",removeAccountFromDevice:"Supprimer le compte de cet appareil",removeAccountTitle:"Supprimer le compte ?",removeAccountWarning:"Cette action supprime définitivement les clés stockées localement et rend ce compte inutilisable dans Wallet. L’historique de la chaîne n’est pas effacé. La restauration nécessite la clé de récupération conservée hors ligne.",typeAccountLabelToConfirm:"Saisissez {label} pour confirmer",removeLocalAccount:"Supprimer le compte local"},
  de:{welcome:"WILLKOMMEN · SELBSTVERWAHRUNG BEGINNT HIER",ownAccount:"Behalte die Kontrolle über dein Konto.",recoverReplacement:"Auf einem Ersatzgerät wiederherstellen",beforeBegin:"Bevor du beginnst",walletLocked:"WALLET GESPERRT",checkingBiometrics:"Biometrie wird geprüft…",lostDeviceRecovery:"Wiederherstellung bei Geräteverlust",nativeAccount:"NATIVES KONTO",send:"Senden",receive:"Empfangen",activity:"Aktivität",accountSafety:"Kontosicherheit",lockWallet:"Wallet sperren",createAnother:"Weiteres Konto erstellen",importAnother:"Wiederherstellungsschlüssel importieren",authorizationLead:"Prüfe jede Bindung. Die Genehmigung teilt nur einen öffentlichen Kontonachweis.",aiSecurity:"KI-Sicherheitserklärung",aiCannotApprove:"KI kann weder signieren noch genehmigen.",removeAccountFromDevice:"Konto von diesem Gerät entfernen",removeAccountTitle:"Konto entfernen?",removeAccountWarning:"Dadurch wird das lokale Schlüsselmaterial dauerhaft entfernt und das Konto kann in Wallet nicht mehr verwendet werden. Der Verlauf auf der Blockchain wird nicht gelöscht. Zur Wiederherstellung ist der offline gespeicherte Wiederherstellungsschlüssel erforderlich.",typeAccountLabelToConfirm:"Zur Bestätigung {label} eingeben",removeLocalAccount:"Lokales Konto entfernen"},
  pt:{welcome:"BOAS-VINDAS · A AUTOCUSTÓDIA COMEÇA AQUI",ownAccount:"Controle sua conta.",recoverReplacement:"Recuperar em um dispositivo substituto",beforeBegin:"Antes de começar",walletLocked:"WALLET BLOQUEADA",checkingBiometrics:"Verificando biometria…",lostDeviceRecovery:"Recuperação de dispositivo perdido",nativeAccount:"CONTA NATIVA",send:"Enviar",receive:"Receber",activity:"Atividade",accountSafety:"Segurança da conta",lockWallet:"Bloquear Wallet",createAnother:"Criar outra conta",importAnother:"Importar chave de recuperação",authorizationLead:"Revise cada vínculo. A aprovação compartilha apenas uma prova pública da conta.",aiSecurity:"Explicação de segurança por IA",aiCannotApprove:"A IA não pode assinar nem aprovar.",removeAccountFromDevice:"Remover conta deste dispositivo",removeAccountTitle:"Remover conta?",removeAccountWarning:"Isso remove permanentemente o material de chaves local e impede o uso desta conta na Wallet. O histórico da rede não é apagado. A recuperação exige a chave de recuperação guardada offline.",typeAccountLabelToConfirm:"Digite {label} para confirmar",removeLocalAccount:"Remover conta local"},
  ru:{welcome:"ДОБРО ПОЖАЛОВАТЬ · САМОСТОЯТЕЛЬНОЕ ХРАНЕНИЕ",ownAccount:"Управляйте своим аккаунтом.",recoverReplacement:"Восстановить на новом устройстве",beforeBegin:"Перед началом",walletLocked:"WALLET ЗАБЛОКИРОВАН",checkingBiometrics:"Проверка биометрии…",lostDeviceRecovery:"Восстановление при потере устройства",nativeAccount:"НАТИВНЫЙ АККАУНТ",send:"Отправить",receive:"Получить",activity:"Активность",accountSafety:"Безопасность аккаунта",lockWallet:"Заблокировать Wallet",createAnother:"Создать другой аккаунт",importAnother:"Импортировать ключ восстановления",authorizationLead:"Проверьте каждую привязку. Разрешение передает только публичное подтверждение аккаунта.",aiSecurity:"Объяснение безопасности ИИ",aiCannotApprove:"ИИ не может подписывать или разрешать.",removeAccountFromDevice:"Удалить аккаунт с этого устройства",removeAccountTitle:"Удалить аккаунт?",removeAccountWarning:"Локальные ключевые данные будут удалены навсегда, и аккаунт станет недоступен в Wallet. История блокчейна не удаляется. Для восстановления нужен ключ восстановления, сохранённый офлайн.",typeAccountLabelToConfirm:"Для подтверждения введите {label}",removeLocalAccount:"Удалить локальный аккаунт"},
  ar:{welcome:"مرحبًا · الحفظ الذاتي يبدأ هنا",ownAccount:"امتلك التحكم في حسابك.",recoverReplacement:"الاسترداد على جهاز بديل",beforeBegin:"قبل البدء",walletLocked:"المحفظة مقفلة",checkingBiometrics:"جارٍ التحقق من المقاييس الحيوية…",lostDeviceRecovery:"استرداد الجهاز المفقود",nativeAccount:"الحساب الأصلي",send:"إرسال",receive:"استلام",activity:"النشاط",accountSafety:"أمان الحساب",lockWallet:"قفل المحفظة",createAnother:"إنشاء حساب آخر",importAnother:"استيراد مفتاح الاسترداد",authorizationLead:"راجع كل ارتباط. لا تشارك الموافقة سوى إثبات حساب عام.",aiSecurity:"شرح أمان بالذكاء الاصطناعي",aiCannotApprove:"لا يمكن للذكاء الاصطناعي التوقيع أو الموافقة.",removeAccountFromDevice:"إزالة الحساب من هذا الجهاز",removeAccountTitle:"هل تريد إزالة الحساب؟",removeAccountWarning:"سيؤدي ذلك إلى إزالة بيانات المفاتيح المحلية نهائيًا، ولن يعود هذا الحساب متاحًا للاستخدام في Wallet. لن يُحذف سجل السلسلة. تتطلب استعادة الحساب مفتاح الاسترداد المحفوظ دون اتصال.",typeAccountLabelToConfirm:"اكتب {label} للتأكيد",removeLocalAccount:"إزالة الحساب المحلي"},
  id:{welcome:"SELAMAT DATANG · SWAKUSTODI DIMULAI DI SINI",ownAccount:"Kendalikan akun Anda.",recoverReplacement:"Pulihkan di perangkat pengganti",beforeBegin:"Sebelum memulai",walletLocked:"WALLET TERKUNCI",checkingBiometrics:"Memeriksa biometrik…",lostDeviceRecovery:"Pemulihan perangkat hilang",nativeAccount:"AKUN NATIF",send:"Kirim",receive:"Terima",activity:"Aktivitas",accountSafety:"Keamanan akun",lockWallet:"Kunci Wallet",createAnother:"Buat akun lain",importAnother:"Impor kunci pemulihan",authorizationLead:"Tinjau setiap ikatan. Persetujuan hanya membagikan bukti akun publik.",aiSecurity:"Penjelasan keamanan AI",aiCannotApprove:"AI tidak dapat menandatangani atau menyetujui.",removeAccountFromDevice:"Hapus akun dari perangkat ini",removeAccountTitle:"Hapus akun?",removeAccountWarning:"Tindakan ini menghapus materi kunci lokal secara permanen dan membuat akun ini tidak dapat digunakan di Wallet. Riwayat blockchain tidak dihapus. Pemulihan memerlukan kunci pemulihan yang disimpan secara offline.",typeAccountLabelToConfirm:"Ketik {label} untuk mengonfirmasi",removeLocalAccount:"Hapus akun lokal"},
};
...
const DETAIL_MESSAGES={
  ...
  "This mined transfer is covered by the node’s verified local snapshot checkpoint. This is not a consensus finality claim.":["这笔已入块转账已纳入经核验的节点本地快照检查点。这不代表共识最终确认。", "هذا التحويل المُدرج في كتلة مشمول بنقطة تحقق موثقة للقطة المحلية للعقدة. لا يعني ذلك نهائية الإجماع."],
