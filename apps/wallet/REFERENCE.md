...
- [Reown WalletKit React Native documentation](https://docs.reown.com/walletkit/react-native/installation): external compatibility transport. WalletConnect namespaces never widen the exact Wallet-approved chain, account, methods or events and never become Product Session authority.
