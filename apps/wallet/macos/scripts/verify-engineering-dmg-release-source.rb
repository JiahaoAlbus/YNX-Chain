...
requirements = [
  ...
  "value of attribute \"AXIdentifier\" of candidate",
  "wantedVisibleText",
  "candidateText contains wantedVisibleText",
  "candidateText to candidateText & \" \" & (value of attribute \"AXValue\" of candidate as text)",
  "candidateText to candidateText & \" \" & (value of attribute \"AXTitle\" of candidate as text)",
  "candidateText to candidateText & \" \" & (value of attribute \"AXDescription\" of candidate as text)",
  "candidateText to candidateText & \" \" & (name of candidate as text)",
  "read_wallet_accessibility \"YNX device recovery action\" \"Prepare device recovery\"",
  "read_wallet_accessibility \"YNX device recovery status\" \"Product account recovery remains unavailable.\"",
  "set candidateEnabled to \"false\"",
  "set candidateEnabled to value of attribute \"AXEnabled\" of candidate as text",
  "value of attribute \"AXEnabled\" of candidate",
