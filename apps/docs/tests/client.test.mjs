...
test('Docs protects canonical auth, autosave, conflict recovery, AI review and delete',async()=>{
  ...
  assert.match(js,/https:\/\/web4\.ynxweb4\.com\/docs-app\/auth\/callback/);assert.match(js,/location\.pathname\.startsWith\('\/docs-app\/'\)\?'\/docs-app\/api\/v1':'\/api\/v1'/);assert.doesNotMatch(js,/docs\.staging\.ynx\.network/);
