...
// The two new scopes are proposed to the Wallet registry, not silently mapped
// from application/controls permission. A current session lacking them is denied.
