...
export type CardScope='account:read'|'card:application:write'|'card:controls:write'|'card:dispute:write'|'card:topup:write'|'card:simulation:write'|'card:finance:share';
