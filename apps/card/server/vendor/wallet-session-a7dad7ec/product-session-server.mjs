...
var ProductSessionServerAuthorizer = class {
  ...
  async authorize(input) {
    ...
    if (input.origin !== this.#binding.origin && !(input.origin === null && this.#binding.platform !== "web")) fail6("ORIGIN_MISMATCH", "Request origin does not match the configured product");
