...
function declineMessage(code:string):string{return({CARD_FROZEN:"Card is frozen in Testnet simulation",CARD_CLOSED:"Card is closed in Testnet simulation",INSUFFICIENT_BALANCE:"Insufficient Testnet YNXT balance",MAX_TRANSACTION_EXCEEDED:"Testnet transaction limit exceeded",ONLINE_DISABLED:"Online simulation is disabled",RECURRING_DISABLED:"Recurring simulation is disabled",INTERNATIONAL_DISABLED:"International simulation is disabled",MCC_BLOCKED:"Merchant category is blocked",MCC_NOT_ALLOWED:"Merchant category is not allowed",MERCHANT_BLOCKED:"Simulated merchant is blocked",MERCHANT_NOT_ALLOWED:"Simulated merchant is not allowed",COUNTRY_NOT_ALLOWED:"Simulated merchant country is not allowed",DAILY_LIMIT_EXCEEDED:"Daily Testnet limit exceeded",MONTHLY_LIMIT_EXCEEDED:"Monthly Testnet limit exceeded",VELOCITY_EXCEEDED:"Too many simulated authorization attempts",INVALID_AMOUNT:"Invalid Testnet amount"}as Record<string,string>)[code]??"Testnet simulation declined"}
