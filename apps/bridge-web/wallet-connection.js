...
export const WALLET_INSTALLATION_OPTIONS=Object.freeze({ynx:'https://www.ynxweb4.com/dapp/download#wallet',metamask:'https://metamask.io/download/'});
export const YNX_TESTNET_ADD_CHAIN=Object.freeze({chainId:'0x1917',chainName:'YNX Testnet',nativeCurrency:Object.freeze({name:'YNX Testnet',symbol:'YNXT',decimals:18}),rpcUrls:Object.freeze(['https://evm.ynxweb4.com']),blockExplorerUrls:Object.freeze(['https://explorer.ynxweb4.com'])});
...
export async function connectBridgeWallet(choice,windowLike=window,{timeoutMs=250}={}){
  ...
  const injected=choice==='metamask'&&windowLike?.ethereum?.isMetaMask?{provider:windowLike.ethereum,info:{name:'MetaMask',rdns:'io.metamask'}}:null;
  ...
  return Object.freeze({account:connected.account,chainId,connection,walletName:selected.info?.name||(choice==='ynx'?'YNX Wallet':'MetaMask'),standardConnection:'CONNECTED',productSession:'PRIVATE_SERVICE_DEGRADED'});
}
