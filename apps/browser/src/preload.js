...
contextBridge.exposeInMainWorld("ynxBrowser", Object.freeze({
  ...
  reviewTransaction: invoke("browser:transaction-review"), aiPrepare: invoke("browser:ai-prepare"), aiCurrentPage: invoke("browser:ai-current-page"), aiRun: invoke("browser:ai-run"), aiCancel: invoke("browser:ai-cancel"), aiReview: invoke("browser:ai-review"),
