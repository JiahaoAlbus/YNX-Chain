...
const android=(await readFile(new URL("android/app/src/main/java/com/ynxweb4/video/MainActivity.java",root),"utf8"))+(await readFile(new URL("android/app/src/main/java/com/ynxweb4/video/CentralContracts.java",root),"utf8")),manifest=await readFile(new URL("android/app/src/main/AndroidManifest.xml",root),"utf8"),swift=await readFile(new URL("ios/YNXVideo/ContentView.swift",root),"utf8"),plist=await readFile(new URL("ios/YNXVideo/Info.plist",root),"utf8"),studio=await readFile(new URL("../creator-studio/i18n.js",root),"utf8");
