...
const catalog={};
export const ready=fetch("/i18n/catalog.json").then(response=>{if(!response.ok)throw new Error("i18n unavailable");return response.json()}).then(data=>{catalog=data;apply();return data});
