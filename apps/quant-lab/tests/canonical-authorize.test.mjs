...
const request=Object.freeze({version:'1',nonce:'a'.repeat(32),chainId:'ynx_6423-1',requestingProduct:'quant',productClientId:'ynx-quant-v1',bundleId:'com.ynxweb4.quant',productDeviceAlgorithm:'p256-sha256',productDeviceKey:'Aq'.padEnd(44,'A'),callback:'https://quant.ynxweb4.com/wallet-auth/callback',scopes:['quant:account'],purpose:'Connect Quant research only.',issuedAt:now.toISOString(),expiresAt:new Date(now.getTime()+60_000).toISOString()});
