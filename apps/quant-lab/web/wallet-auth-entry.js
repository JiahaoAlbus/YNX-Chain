...
let standardWallet=null,standardWalletState=createStandardWalletConnectState(),standardProvider=null,standardConnection=null,detachProviderEvents=()=>{},walletRevision=0,walletIntent=0,walletBusy=false,revokingConnection=null;
window.YNXQuantWallet=Object.freeze({connect:beginAuthorization,handleCallback:handlePrivateReturn,requireProof:requireNativeExecutionProof,retry:beginAuthorization,revoke:revokePrivateSession,beginPrivateSession,retryPrivateSession,getPrivateSessionState,privateAccount,revokeStandardWallet,connectMetaMask,restoreStandardWallet,disconnectStandardWallet,getStandardWalletState:()=>standardWalletState,readPortfolio,reportRpcProbe:reportQuantRpcProbe});
