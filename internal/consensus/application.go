...
func cloneExecutionStateValue(state executionState) executionState {
	return executionState{
		...
		payIntents: append([]BFTPayIntent(nil), state.payIntents...), paySettlements: append([]BFTPaySettlement(nil), state.paySettlements...), payInvoices: append([]BFTPayInvoice(nil), state.payInvoices...), payRefunds: append([]BFTPayRefund(nil), state.payRefunds...), payWebhooks: append([]BFTPayWebhook(nil), state.payWebhooks...), payEvents: append([]BFTPayEvent(nil), state.payEvents...), payIdempotency: append([]BFTPayIdempotency(nil), state.payIdempotency...),
