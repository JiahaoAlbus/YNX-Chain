...
func TestSellerDataExportIsOwnerOnlyStoreScopedAndDeepCopied(t *testing.T) {
	...
	if exported.SchemaVersion != sellerDataExportSchemaVersion || exported.SnapshotVersion != currentSnapshotVersion || exported.Source != "ynx-seller-console-local-authority" {
