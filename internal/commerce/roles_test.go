...
func TestSnapshotV2ManagerMigratesToAdmin(t *testing.T) {
	...
	if migrated.s.Version != CurrentPersistenceSchemaVersion || migrated.s.SellerRoles["store_legacy"]["ynx_legacy"] != SellerRoleAdmin || migrated.s.SellerRevocations == nil || migrated.s.SellerInvitations == nil || migrated.s.SellerEvents == nil || migrated.s.ProviderConfigs == nil {
