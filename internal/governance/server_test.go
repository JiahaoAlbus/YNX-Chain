...
func TestServerPublicReadsExposeSourceAndNoSecrets(t *testing.T) {
	...
	for _, path := range []string{"/health", "/version", "/proposals", "/votes", "/delegations", "/roles", "/parameters", "/timelocks", "/executions", "/upgrades", "/canaries", "/emergency-actions", "/treasury", "/providers", "/conflicts", "/appeals", "/audit", "/governance/objects", "/governance/proposals", "/governance/canaries", "/governance/emergencies", "/governance/appeals", "/governance/roles"} {
