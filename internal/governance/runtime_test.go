...
func runtimeFixture(t *testing.T) (RuntimeConfig, time.Time) {
	...
	return RuntimeConfig{SchemaVersion: "ynx-governanced-config/v3", HTTPAddress: "127.0.0.1:6441", StatePath: filepath.Join(dir, "state.json"), GatewayKeyPath: keyPath, Policy: RuntimePolicyConfig{ChainID: "ynx-governance-testnet-1", VoteDomain: "ynx-governance.vote.v1", VoteReplacementPolicy: "replace_before_deadline", VoteWithdrawalPolicy: "withdraw_before_deadline", VoteMaxClockSkew: "2m", MinimumDeposit: 100, QuorumBPS: 5000, ThresholdBPS: 6667, VotingPeriod: "1h", Timelock: "2h", TimelockGrace: "6h", MaxLifetime: "720h", EmergencyThreshold: 3, EmergencyMaxDuration: "24h", ParameterRules: map[string]ParameterRule{"/bridge/exposureLimit": {Scope: ScopeBridge, Numeric: true, Minimum: 0, Maximum: 500_000_000}}, GenesisRoleManifestHash: manifest, ElectorateApprovalThreshold: 2}, GenesisRoles: roles}, now
}
