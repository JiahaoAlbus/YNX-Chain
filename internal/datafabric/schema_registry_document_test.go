...
func TestSchemaRegistryDocumentIsDeterministicAndStrictlyReloadable(t *testing.T) {
	...
	if loaded.Version() != "2.0" || len(definitions) != 92 {
	...
	for _, definition := range definitions {
		if definition.Version == EnvelopeSchemaVersionV2 {
			if definition.SourceCommit != "9fc1986067b92f3dd2ea2347223d94e94cc06de9" || definition.Release != "data-fabric-contract-v2" {
