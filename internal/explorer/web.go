...
<body>
  ...
  <script>
    ...
    const sourceTruth = value => String(value || '') === 'rpc-and-indexer-backed' ? runtime('sourceVerified') : runtime('sourceUnavailable');
    const walletUI = {
