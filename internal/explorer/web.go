...
<body>
  ...
  <script>
    ...
    const initialUI = {
      en:{loadingBlocks:'Loading blocks…',loadingTransactions:'Loading transactions…',validator:'Validator',role:'Role',status:'Status',votingPower:'Voting power',observedHeight:'Observed height',loadingValidators:'Loading validators…',loadingResourceMarket:'Loading resource market…',loadingAccounts:'Loading accounts…',rank:'Rank',account:'Account',balance:'Balance',staked:'Staked',nonce:'Nonce',loadingAccountBalances:'Loading authoritative account balances…',chainDetail:'Chain detail',loading:'Loading',loadingLiveChain:'Loading live chain data…',all:'All',transfers:'Transfers',resources:'Resources',faucet:'Faucet',range24h:'24h',range7d:'7d',range30d:'30d',pagination:'pagination'},
      'zh-CN':{loadingBlocks:'正在加载区块…',loadingTransactions:'正在加载交易…',validator:'验证者',role:'角色',status:'状态',votingPower:'投票权重',observedHeight:'观测高度',loadingValidators:'正在加载验证者…',loadingResourceMarket:'正在加载资源市场…',loadingAccounts:'正在加载账户…',rank:'排名',account:'账户',balance:'余额',staked:'已质押',nonce:'随机数',loadingAccountBalances:'正在加载权威账户余额…',chainDetail:'链上详情',loading:'正在加载',loadingLiveChain:'正在加载实时链上数据…',all:'全部',transfers:'转账',resources:'资源',faucet:'水龙头',range24h:'24 小时',range7d:'7 天',range30d:'30 天',pagination:'分页'},
      'zh-TW':{loadingBlocks:'正在載入區塊…',loadingTransactions:'正在載入交易…',validator:'驗證者',role:'角色',status:'狀態',votingPower:'投票權重',observedHeight:'觀測高度',loadingValidators:'正在載入驗證者…',loadingResourceMarket:'正在載入資源市場…',loadingAccounts:'正在載入帳戶…',rank:'排名',account:'帳戶',balance:'餘額',staked:'已質押',nonce:'隨機數',loadingAccountBalances:'正在載入權威帳戶餘額…',chainDetail:'鏈上詳情',loading:'正在載入',loadingLiveChain:'正在載入即時鏈上資料…',all:'全部',transfers:'轉帳',resources:'資源',faucet:'水龍頭',range24h:'24 小時',range7d:'7 天',range30d:'30 天',pagination:'分頁'},
      ja:{loadingBlocks:'ブロックを読み込み中…',loadingTransactions:'トランザクションを読み込み中…',validator:'バリデーター',role:'ロール',status:'状態',votingPower:'投票パワー',observedHeight:'観測ブロック高',loadingValidators:'バリデーターを読み込み中…',loadingResourceMarket:'リソース市場を読み込み中…',loadingAccounts:'アカウントを読み込み中…',rank:'順位',account:'アカウント',balance:'残高',staked:'ステーク済み',nonce:'ノンス',loadingAccountBalances:'信頼できるアカウント残高を読み込み中…',chainDetail:'チェーン詳細',loading:'読み込み中',loadingLiveChain:'ライブチェーンデータを読み込み中…',all:'すべて',transfers:'送金',resources:'リソース',faucet:'フォーセット',range24h:'24時間',range7d:'7日間',range30d:'30日間',pagination:'ページネーション'},
      ko:{loadingBlocks:'블록을 불러오는 중…',loadingTransactions:'트랜잭션을 불러오는 중…',validator:'검증인',role:'역할',status:'상태',votingPower:'투표 지분',observedHeight:'관측 높이',loadingValidators:'검증인을 불러오는 중…',loadingResourceMarket:'리소스 시장을 불러오는 중…',loadingAccounts:'계정을 불러오는 중…',rank:'순위',account:'계정',balance:'잔액',staked:'스테이킹됨',nonce:'논스',loadingAccountBalances:'신뢰할 수 있는 계정 잔액을 불러오는 중…',chainDetail:'체인 세부 정보',loading:'불러오는 중',loadingLiveChain:'실시간 체인 데이터를 불러오는 중…',all:'전체',transfers:'전송',resources:'리소스',faucet:'수도꼭지',range24h:'24시간',range7d:'7일',range30d:'30일',pagination:'페이지 나누기'}
    };
