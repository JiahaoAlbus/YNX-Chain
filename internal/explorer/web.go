  ...
  <main>
    <div class="shell">
      ...
      <section class="wallet-band">
        <div><h2 data-i18n="identityTitle">YNX-native identity comes first.</h2><p data-i18n="identityCopy">YNX applications use the checksummed ynx1 address by default. Standard MetaMask remains available through the isolated EVM compatibility adapter for the same account.</p></div>
        <button id="metamaskButton" class="wallet-button" type="button" data-i18n="openMetamask">Open MetaMask compatibility</button>
      </section>
    </div>
  </main>
