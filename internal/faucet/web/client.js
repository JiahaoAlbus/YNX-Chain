...
export class FaucetClient {
 ...
 if(r.status===202&&p.durable){if(b.status!=='pending'||b.retrySameRequest!==true||b.requestId!==p.requestId||b.address!==normalizeRecipient(p.address)||b.amount!==p.amount||b.nativeSymbol!=='YNXT'||b.transaction?.hash)throw this.error('badReceipt');this.save({...p,pendingAccepted:true});return{pending:true}}
