...
- `make economics-integration-contract-check` — pass; freezes release truth, supply/fee boundaries, canonical events and error codes, and replays both economics and staking vectors to exact state hashes.
