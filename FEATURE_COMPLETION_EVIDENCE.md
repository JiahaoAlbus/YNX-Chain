...
| Strategy Vault / execution adapter | not implemented | No authoritative source or tests found. | Mandate enforcement, owner-only withdrawal, limits, kill/revoke/emergency exit, fee invariant and Quant integration vectors. |
