...
| Tip, split and recurring draft | partial | Tip is implemented in invoice v3 across central intent creation, merchant signature, strict Pay parsing, 12-locale review UI and authoritative total matching; Split and Recurring Draft remain unavailable pending their versioned central/Wallet contracts |
