...
- Current authoritative Testnet payment and refund: `apps/pay/evidence/authoritative-testnet-refund-2026-08-11.json`. A fresh 7 YNXT payment committed in block 951654 and the merchant Wallet sent 2 YNXT back to the exact payer in block 951663. Two-phase central authority, transaction direction, independent RPC/block membership, receipt, audit, webhook and gross/refunded/net reconciliation all matched before the product reported `refunded`.
- Current two-account Split: `apps/pay/evidence/authoritative-testnet-split-2026-08-11.json`. Two distinct Wallet identities claimed expected-payer-bound Invoice v4 shares for 3 and 4 YNXT, committed in blocks 951937 and 951948, and the public aggregate reached `committed` without exposing payer accounts. Independent RPC/block membership and 14/2/12 gross/refunded/net reconciliation matched.
