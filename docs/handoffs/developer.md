...
- The audit passed 15/15 checks and generated six PNGs with exact SHA-256 values in `apps/developer/evidence/ui/current-accessibility/accessibility-audit.json`. Developer Web now passes 21/21 local tests; artifact-source Windows CI passed 20/20 before the release-record consistency gate was added. Static claim/workflow gate remains passed.
- Current-source API Studio installed-local evidence now exists on both macOS arm64 and Windows x64 from source `7f976c1e06292360160325b00fa0875e6a2567f6`. The macOS ZIP SHA-256 is `ff9ae3d473f961f38294679a7bdb21c7cc0c905d7791efe9d4b114fc1df903f7`; extracted self-test, ad-hoc/no-Team-ID classification, GUI cold launch, bundled server observation and cleanup passed. Windows workflow run `30417693593`, job `90467659180`, ZIP SHA-256 `1efaf486164da71d907a8869e5e749fe46bf0bb1a74625f12ddab1692d07fb29`, portable extraction, native self-test, WPF cold launch, bundled server observation and child cleanup passed.
- The Windows Artifact `8710756758` is transient and expires `2026-08-12T02:46:59Z`; neither desktop package is production-signed or an immutable public download yet.
