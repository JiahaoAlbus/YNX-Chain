...
| Quant | Bounded Exchange Testnet execution, tenant isolation, restart and kill/revoke | proven-public Testnet | Current public runtime is `443286487e057d78cb6b1a686d14bb37be8b3c23`; owner-read deployment self-test, public health, race/UI/browser tests and ComputerControl UI evidence: `apps/quant-lab/evidence/public-financial-owner-reads-deployment-20260815-44328648.json` |
