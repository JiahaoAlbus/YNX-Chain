...
| DEX | Multi-hop routing, Strategy Vault, FairFlow, concentrated liquidity, LP protection, kill/revoke/emergency exit | Strategy Vault, FairFlow and concentrated accounting tested-local; remaining capabilities partial / missing-public | Local evidence: `docs/evidence/dex/strategy-vault-local-2026-08-13.json`, `docs/evidence/dex/advanced-liquidity-local-2026-08-13.json`; public Wallet mandate, advanced-pool and transaction evidence remains absent |
