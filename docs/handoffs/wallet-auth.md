...
- Dependency/license boundary now includes a release-grade deterministic CycloneDX 1.6 runtime SBOM. The generator is pinned to `@cyclonedx/cyclonedx-npm@6.0.0`; `npm run sbom:check` proves a clean npm 11 production tree, 431 components, 504 dependency nodes, license metadata for all 431 components and current SHA-256 `7d1afd4f176776840a45c131843cde1550154f738a1e3da67f1163cf88dab633` without `--ignore-npm-errors`.
