...
The current consumed checkpoints are Core `b8467853060db04c2981abb7fcfa22d4cfdcf65b`, Web `7d569d1babb85e6d28bb6bfc3b3c0c5fd828255d`, Android `f1edbec46ad4300beec406873b03db2da7c72e4b`, iOS/macOS `50d3b2e2c5bd77456b84f348c48fa4a9ed76b5b3`, and Desktop/CLI/SDK `6856bf41f79ffdb0a637d7e1cad11e6931158d67`. Android canonical authorization now persists an exact pending response and resumes it without re-signing; this is local source evidence, not device callback delivery. Desktop evidence proves the macOS arm64 CLI bytes on a public Vercel Blob URL, but there is no official YNX-domain URL or website registry deployment, so `downloadHosted` and `deployedPublic` remain false.
