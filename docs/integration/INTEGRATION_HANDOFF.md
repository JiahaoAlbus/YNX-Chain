...
Envelope v2 may carry optional `chainCommitmentId` as an external Chain Core Bulk Data Commitment reference. Data Fabric consumes frozen Chain Core contract v1.24.0, implementation `f544eff9d20f9db3834d25b4a6f6737e367d1e0b`, contract commit `fef6c84e9bb30ebfc57f7a30123b4976096c9b61`, from the verified 71,070,452-byte v24 bundle with SHA-256 `0ed809a89ec06757f1cfc4ddba8701c2e72e9296326ea01558afbed07c60d7aa`. It accepts only an exact successful `GET /data/commitments/{id}` read from `ynx-consensus-abci` at `abci-state-v14`. Missing, unavailable or contradictory verification rejects before storage. Data Fabric neither computes the commitment ID nor accepts a write owner; Chain Core derives owner from the transaction signer. Raw content, plaintext metadata, recipient lists, access tokens and key material remain off-chain. v24 does not change the Data Commitment ID, owner, version-chain, finality, consensus, v22 strategy-action or v23 reproducible-solc semantics. It adds exact quorum-intersection cardinality evidence at 4, 7, 13 and 21 validators and advances the integration contract to 99 vectors. Full state-machine safety, independent TLC/Apalache, differential replay, WAN soak and public promotion remain explicitly unproven; public/deployed/integratedCentral stay false.
