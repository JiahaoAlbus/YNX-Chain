...
P0 Wallet Protocol P0-003 accepts runtime compatibility commit `49e30d999e9a9cbdd2c565021009f2cab0dc125c` plus verifier `30ba2a0c…` for one owner-scoped transaction under lease `P0-WALLET-CONNECTIVITY-2026-08-runtime-lease-20260820T095840Z`, expiring `2026-08-20T11:58:40Z`, on authoritative base `15d5ae2b…`. Origin Binding provenance remains `5231e750…`; registry blob `f11f73bb…` / SHA-256 `ae156b31…` is unchanged. The fix accepts both historical v1 state shapes, verifies `accountPublicKey` when present and always retires v1 authority; no Origin inference or authority upgrade is allowed. Exact `49e30d99…` must pass a read-only boot against copied 18445 state before mutation. Public remains healthy source `6ed04310…`, OPTIONS 405; no activation occurred and every integrated/public/CORS/lifecycle/client gate remains false.
