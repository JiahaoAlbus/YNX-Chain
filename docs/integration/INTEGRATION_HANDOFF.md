...
The current consumed checkpoints are Core `0c747c6030b5a475a1f12dc7e57345555c23055d`, Web `7d569d1babb85e6d28bb6bfc3b3c0c5fd828255d`, Android `f1edbec46ad4300beec406873b03db2da7c72e4b`, iOS/macOS `50d3b2e2c5bd77456b84f348c48fa4a9ed76b5b3`, and Desktop/CLI/SDK `6856bf41f79ffdb0a637d7e1cad11e6931158d67`. Core now has a strict all-or-nothing deployment evidence verifier, but its recorded execution is isolated/mocked and explicitly says no public execution occurred. Android canonical authorization recovery remains local source evidence, not device callback delivery. Desktop proves exact bytes on a public Vercel Blob URL, but there is no official YNX-domain URL or website registry deployment, so `downloadHosted` and `deployedPublic` remain false.
