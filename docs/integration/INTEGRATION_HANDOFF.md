...
The same release record binds external Chain Core contract version `1.27.0`: implementation `a456daeca2f89af65ac39840efb40ada1cba2e29`, contract `f55934b7d5a24abf0e6de471441cceacc47ad5e7`, tree `978ac223dea5c51ab9491fd21707a91e3f36aec9`, contract blob `e6595dc5231fd7c863a68b3797e329d5f662ddd0`, package `e19b236f91a4889ecbd98b2f9e6b80a45c4ff654`, and readiness head `e3ae947b6396efa1ae6534652ca017c25069663e`. The exact 111,258,870-byte bundle hashes to `39120dab…03cd6`. This accepts the contract identity and local validator-safety evidence only. Wallet/Auth remains Product Session authority; Chain Core remains fail-closed with its Auth dependency not accepted and no parallel Auth protocol. Because the commit is not exposed by the shared origin and no matching public runtime evidence exists, `integratedCentral`, staging/public deployment and all release-distribution promotions remain false.
...
The unique public endpoint/mobile discovery contract is `release/integration/wallet-auth-public-endpoint-service-discovery-matrix.json`, documented by `docs/integration/WALLET_AUTH_PUBLIC_ENDPOINT_SERVICE_DISCOVERY.md` and enforced by the public evidence audit checker. It explicitly separates injected-provider, YNX Wallet canonical authorization deep-link/callback, and MetaMask mobile DApp-link flows. Faucet 502, missing browser CORS, missing v2 OPTIONS/CORS, the split RPC URLs and every unproved mobile account/sign/send outcome remain fail-closed.
