...
The same release record binds external Chain Core contract version `1.30.0`: implementation `aab0b6b9fc28b40ef8715214cd95360734db4c48`, contract `3bcae14f9d42fd2fbcce2211a7c51a737f8ed464`, tree `aa84d7b1ff15285d479fc784c28928021fcc8497`, contract blob `6df6d0e7bf7ac77bdaf0f9349d24c924b021c4a0`, package `3de79e37aba04c22d2cc90809a6bcef83c48356c`, and readiness head `1adbcd664b040f17644cea4140eb6e50aba111aa`. The exact 141,977,791-byte bundle hashes to `49603252…8162`. This accepts contract identity and local authenticated SafetyStore/ValidatorVoteSigner evidence only. A trusted external monotonic rollback anchor, external signer custody, Chain Core Auth dependency acceptance, `integratedCentral`, staging/public deployment and release promotions remain false.
