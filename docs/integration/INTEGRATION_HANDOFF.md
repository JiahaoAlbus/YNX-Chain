...
P0 Wallet Protocol runtime lease `…T095840Z` is closed successfully by exact evidence `b30775951dcea09bf6b72aeb4806f47ff81b3bef` / blob `6e426777…`. Public source is `49e30d99…`; registry SHA-256 remains `ae156b31…`; rollback restored `6ed04310…` and state `e05306a6…` before final activation. Runtime deployment, registered-Origin CORS and public lifecycle are directly verified true. Installed-client lease `…T101002Z` and Website publication handoff are issued but unexecuted. Standard wallet/account/sign/send/transaction, `integratedCentral`, Website publication, production signing, store and aggregate readiness remain false.
