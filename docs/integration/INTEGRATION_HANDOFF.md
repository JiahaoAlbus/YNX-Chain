...
- Current committed-state schema is v11 with AppHash domain `YNX_ABCI_STATE_V11`; ABCI application version is 15 and State Sync snapshot format is 1.
