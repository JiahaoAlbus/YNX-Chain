...
Envelope v2 may carry optional `chainCommitmentId` as an external Chain Core Bulk Data Commitment reference. Data Fabric consumes frozen Chain Core contract v1.33.0, implementation `78fc2a9df2304cf8509a4c90aa7856cc748e3b57`, contract commit `00f3daa83355b8a482af5d9240e78ebd91dd7995`, from the verified 159,859,137-byte v33 bundle with SHA-256 `3b31810077b008d3490de91d26a8b70b385d73241db6664dabac5f17a616d772`. It accepts only an exact successful `GET /data/commitments/{id}` read from `ynx-consensus-abci` at `abci-state-v14`; contradiction or unavailability rejects before storage. Data Fabric neither computes the ID nor accepts a write owner, and raw content, recipient lists, tokens, keys and private signer material remain off-chain. v33 leaves Bulk Data Commitment, owner/finality and state/application semantics unchanged. The existing complete-envelope CAS/readback/recovery and mTLS client semantics remain; v33 adds the external server authority boundary with verified client certificates and PostgreSQL CAS. Only fake-driver local repository tests exist: real PostgreSQL, production database/certificates, independent deployment, remote recovery, public validator deployment, WAN/soak, central integration and public cutover remain false/unprovided. The contract has 108 vectors.
