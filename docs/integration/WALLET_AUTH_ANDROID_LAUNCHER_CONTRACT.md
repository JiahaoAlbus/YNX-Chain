...
Core/Auth contract `94c7f3c92caeff6a2e00b4eb311d4145e262823d` (blob `714c2b36017004c1ced8e6eafb6274488d71b9a5`) is the authoritative classification companion. Its strict gate reports 30 blocking release-runtime findings; generated bundles have zero legacy blockers and four canonical literals proven to come from shared-builder imports, while fixtures have zero blockers. This does not waive source callers: each release runtime must use `encodeRequestDeepLink`, platform launchers must implement resolver checks and the explicit component, and direct Pixel 9 approve/reject/callback/session/second-launch evidence is still required.
