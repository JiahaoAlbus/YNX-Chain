...
| Desktop/CLI/SDK | `963e07a3325dd7fff31244d90e89b2f9b13a3809` | Prior desktop/CLI evidence plus TypeScript SDK 0.2.1 reproducible pack, isolated strict consumer, exact `0x1917` and temporary device-proof signing | temporary proof is not production account/tx signing; npm publish/public hosting/production/store remain false |
