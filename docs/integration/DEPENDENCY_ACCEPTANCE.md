...
| Web/PWA/Extensions | `7522b8162b2581c7fed216d0e4e9fef44ff4fef7` | Prior evidence plus exact extension ZIP permission/CSP/URL inspection: activeTab+scripting+storage, only authoritative RPC host, no persistent all-site content script or web-accessible provider | artifact inspection is not browser installation/action runtime; provider/account/sign/tx/hosting/production/store remain false |
...
Web `1ac8c4edd2c8f1b794b3aec9b70b1cf262576f3a`, Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the recorded Desktop/SDK successors remain queued.
