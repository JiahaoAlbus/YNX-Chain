...
| Desktop/CLI/SDK | `d430b44488d1c583e8983b422a825790f479add8` | Prior evidence plus deterministic formal Go 0.1.0 archive, clean extract, real consumer, exact `0x1917`, temporary device proof and artifact re-download verification | install means package consumer only; no public module hosting, production account/tx signing, production/store release |
