...
| Web/PWA/Extensions | `ae55e8272018979abb6cb393307755c063f71f38` | Prior Edge-local runtime evidence plus strict canonical sensitive-request validation and fail-close before backend while Core registry is disabled/pending-review without HTTPS callback | isolated/unpacked is not installedLocal; no canonical account/sign/tx success, Chrome live provider, hosting/production/store remain false |
...
| Desktop/CLI/SDK | `b06bf39c365408ba28e9e5f9312f293693e3f73d` | Prior desktop/CLI/SDK evidence plus Linux arm64 RPM --noscripts native CI with explicit sandbox setup | RPM scripts/Fedora/DNF untested; portable/CI artifacts not installedLocal; unsigned/unnotarized; no public hosting/production/store |
...
Web `a3059db5d7e08e60bfcdf6b590d8217d211e008a` / `f789c782c325d64234bd077f5c878b1821b2149a` / `7522b8162b2581c7fed216d0e4e9fef44ff4fef7`, Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and Desktop CLI `905ac1e5479b08e6b2d9e50a91bef01cbe7d58ef` remain queued.
