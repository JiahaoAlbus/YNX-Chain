...
| Desktop/CLI/SDK | `1cdcc8fbf4b1264bec763ee6c713b353b12380ac` | Prior evidence plus source-bound CycloneDX 1.5 SBOM and provenance payload/archive hashes with CI re-download verification and bounded handoff | handoff adds no gate; SBOM/provenance is unsigned CI metadata; no account/tx, public hosting, production signing/store release |
