...
| Desktop/CLI/SDK | `02acde92b34ba555ed55f5b512d3dd8a48c1412e` | Prior evidence plus Fedora 42 arm64 DNF/RPM scripts, install/upgrade, sandbox, GUI cold/second launch, exact `0x1917`, fail-close, uninstall and artifact re-download | container capabilities are a bounded Electron namespace test; rollback, signing, account/tx, public hosting and store release remain false |
...
Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the Fedora Desktop handoff remain queued; rollback descendants are not consumed.
