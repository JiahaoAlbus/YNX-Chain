...
| YNX Chain Core | Frozen Bulk Data Commitment v1 reference reads plus finalized chain observations | Contract v1.24.0, implementation `f544eff9d20f9db3834d25b4a6f6737e367d1e0b`, contract commit `fef6c84e9bb30ebfc57f7a30123b4976096c9b61`; 71,070,452-byte v24 bundle SHA-256 `0ed809a89ec06757f1cfc4ddba8701c2e72e9296326ea01558afbed07c60d7aa` verified; Envelope v2 fail-closed adapter and positive/negative local tests | Contract consumed locally; shared Testnet pending | Run exact committed/unavailable/mismatch vectors against the accepted Gateway and retain owner-issued receipts |
...
The YNX Pay BFT source-to-Ledger path and the Chain Core Bulk Data Commitment reference boundary have executable local evidence. Chain Core v1.24.0 preserves the Bulk Data Commitment, v22 strategy-action and v23 reproducible-solc semantics while adding exact quorum-subset and ordered-quorum-pair cardinality evidence at 4, 7, 13 and 21 validators, plus a 99-vector integration contract. Data Fabric records those additive owner capabilities but does not redefine them. The quorum evidence explicitly does not substitute for full state-machine safety, independent TLC/Apalache, differential replay, WAN soak or promotion proof. The Data Fabric boundary is deliberately read-only: `chainCommitmentId` is an external reference, owner is not accepted from an event, and raw content, recipient lists, access tokens and key material remain off-chain. Neither path is **centrally accepted** or **shared-Testnet verified**.
