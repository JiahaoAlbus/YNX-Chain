...
| Desktop/CLI/SDK | `ddab97ee88e927558f87eddc2d4a61a09a5bdc80` | Prior evidence plus native macOS 15 Intel CLI install/upgrade, cold/second launch, frozen vector, exact `0x1917`, ephemeral device proof, fail-close, uninstall and artifact re-download | x64 CLI artifact is unsigned and only its installed CI copy was ad-hoc signed; no account/tx, public hosting, production signing/store release |
...
Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the recorded Desktop/SDK handoff and Fedora successors remain queued.
