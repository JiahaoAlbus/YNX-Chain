...
| Desktop/CLI/SDK | `ca1fc40aaadab1421b4681647e619516ff25ff9b` | Prior macOS arm64 CLI lifecycle plus bounded Owner handoff | handoff adds no gate; Blob URL is not official YNX registry, candidate is ad-hoc, no account/tx, official hosting, production signing/store |
