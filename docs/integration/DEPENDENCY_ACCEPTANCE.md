...
Central Integration accepts Chain Core contract version `1.32.0` as the immutable dependency identity for subsequent Wallet/Auth compatibility work. The implementation is `1974dba384a2f0ac1124f4de7025f772fe94bd03`; contract commit `93a95c0005e09ba21f61245f0e001e2acf4a1080` has parent `1974dba3…`, tree `c8d8e0647e7e8de0d21eda2180b6df1d8fe5ff1f`, and contract blob `0f56235839af42606d358937e14a1fa184ed7a02` at `release/integration/chain-core-contract.json` (content SHA-256 `1e8abb9234484aeeca59534eb1f7a3375e2700a76ec2f7c6b53d45ed3230d4d2`). Readiness head is `0164e7f6fea26bafa63ff7ede9b8d05ab47e8dc1`. The local delivery bundle is 146,122,768 bytes with SHA-256 `666118d2fce9d006341142616f03dcf7641748ad3f430d1f3a5f360bc965cbd3` and fixed base `66ea9ba9704dbb0e4863bb9e28ad12eae59ba5a7`.

v32 adds only the deployable mTLS HTTPS client boundary over the local monotonic safety-anchor protocol. No production endpoint, production CA/client certificates, independent authority deployment, remote/WAN recovery drill, soak, external signer custody, central integration or public deployment is provided. Wallet/Auth retains Product Session authority and no parallel Auth protocol is introduced.
