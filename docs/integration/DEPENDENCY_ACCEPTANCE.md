...
| Desktop/CLI/SDK | `c2622ca2e18949ee83625cc97854c2f097c79eee` | Prior evidence plus Fedora 42 x64 RPM/DNF scripts, install/upgrade/rollback/re-upgrade, sandbox, GUI lifecycle, exact `0x1917`, fail-close, uninstall and rehash | native CI only; unsigned, no account/tx, public hosting, production signing or store release |
