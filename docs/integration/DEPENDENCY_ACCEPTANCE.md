...
| --- | --- | --- | --- |
| Core Auth/Gateway | `19277165ec69c3d0dba76050c2529710d43f88b7` | Public isolated-6441 wrong product/device/bundle, scope widening, sibling device revoke and expiry rejection; 294/294 | deployed device+inode pinning and public symlink/hardlink/same-bytes replacement/digest tamper unproved; 6437/6439 absorption, runtime migration, aggregate/central remain false |
