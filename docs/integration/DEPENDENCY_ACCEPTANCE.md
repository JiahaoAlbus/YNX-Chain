...
| Desktop/CLI/SDK | `f46866333b031a43c60d0f759db03edf5cf04fe8` | Prior evidence plus Fedora 42 arm64 DNF/RPM scripts, install/upgrade, sandbox, GUI cold/second launch, exact `0x1917`, fail-close, uninstall, artifact re-download and bounded handoff | handoff adds no gate; container capabilities are a bounded Electron namespace test; rollback, signing, account/tx, public hosting and store remain false |
