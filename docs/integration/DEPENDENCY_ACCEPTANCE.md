...
| Web/PWA/Extensions | `60614bf5e7575c7423a0f8547b5197675f449ffc` | Prior publication verifier plus official Firefox 153.0.4 package verification and disposable-profile temporary add-on first/second launch | temporary add-on is not installed; popup DOM/background, Chrome/Edge runtime, provider/account/sign/tx and current production hosting/public/signing/store remain false |
