...
| Desktop/CLI/SDK | `aa88a6e7a1bb17b5fc46799100e43acdccb26dc6` | Prior evidence plus Linux x64 AppImage portable setuid-sandbox runtime, GUI cold/second launch, exact `0x1917`, fail-close and re-download hash | portable AppImage is not installedLocal; rollback, signing, account/tx, public hosting and store remain false |
