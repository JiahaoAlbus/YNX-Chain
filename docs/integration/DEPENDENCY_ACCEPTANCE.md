...
| Desktop/CLI/SDK | `a65c90c459b231ebbd0250cac7490714c6ed1541` | Prior evidence plus source-bound CycloneDX 1.5 SBOM and provenance payload/archive hashes with CI re-download verification | SBOM/provenance metadata adds no runtime gate and is unsigned CI metadata; no account/tx, public hosting, production signing/store release |
...
Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97`, the SBOM handoff and recorded Fedora Desktop successors remain queued.
