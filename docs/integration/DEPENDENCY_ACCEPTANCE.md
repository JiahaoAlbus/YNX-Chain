...
| 28 Website | Consume `/calendar` metadata, status, downloads, FAQ and structured data | Calendar public metadata and Website handoff are updated for runtime `b00f32da`; public deployment remains unverified | Pending handoff | Website commit consuming exact metadata plus public route and canonical/status probes |
