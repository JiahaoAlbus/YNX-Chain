...
| Desktop/CLI/SDK | `6856bf41f79ffdb0a637d7e1cad11e6931158d67` | Prior macOS arm64 CLI lifecycle plus exact public Vercel Blob HTTP 200, 4,904,463-byte/SHA-256 readback | Blob host is not an official YNX domain or registry; candidate is ad-hoc, no account/tx, official hosting, production signing/store |
