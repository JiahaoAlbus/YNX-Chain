...
| Desktop/CLI/SDK | `0b65e31031f8316b5ea753fe70bd9bea391ef760` | Prior evidence plus native macOS 15 Intel CLI install/upgrade, cold/second launch, frozen vector, exact `0x1917`, ephemeral device proof, fail-close, uninstall, artifact re-download and bounded Owner handoff | handoff adds no gate; x64 CLI artifact is unsigned and only its installed CI copy was ad-hoc signed; no account/tx, public hosting, production signing/store release |
...
Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the recorded Fedora Desktop successors remain queued.
