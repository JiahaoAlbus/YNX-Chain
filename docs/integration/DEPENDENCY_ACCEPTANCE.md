...
| Desktop/CLI/SDK | `fb0b1ac18b809a7b9782fdebc4f9c2c50312fb7b` | Prior evidence plus macOS 14 arm64 CLI native-CI install/upgrade, cold/second start, frozen vectors, ephemeral proof, exact `0x1917`, fail-close, uninstall and rehash | ad-hoc linker signed candidate; no account/tx, official URL, production signing or store release |
