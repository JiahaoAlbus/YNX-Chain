...
| Desktop/CLI/SDK | `195de4618c5762b98a43192719854a62ae78d7b1` | Prior evidence plus deterministic formal Go 0.1.0 archive, clean extract, real consumer, exact `0x1917`, temporary device proof, artifact re-download verification and bounded Owner handoff | install means package consumer only; the handoff adds no product truth; no public module hosting, production account/tx signing, production/store release |
...
Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the recorded Desktop/SDK successors remain queued.
