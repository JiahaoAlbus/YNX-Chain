...
| Web/PWA/Extensions | `7461608692a4d5a349b4c03728850b6d4fbfe6a1` | Immutable publication kit materializes PWA 272,706, Chromium 188,846 and Firefox 188,883 byte artifacts with exact SHA; 3-origin gate self-test passes | production monitor remains unpublished: 0/9 artifact checks and registry source gate fail; install/runtime/account/sign/tx/hosting/production/store remain false |
