...
| Desktop/CLI/SDK | `963e07a3325dd7fff31244d90e89b2f9b13a3809` | Prior desktop/CLI evidence, TypeScript 0.2.1 package evidence, and Go source consumer compile/vector/`0x1917`/temporary device-proof evidence from `6331265a…` | Go formal module archive/install and production account/tx signing are false; npm/module publish, public hosting, production/store remain false |
