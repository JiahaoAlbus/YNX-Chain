...
| Web/PWA/Extensions | `d14a1b00366ff94f76efe3f0d86bec42f1033b15` | Publication kit plus 70/70 source and 3/3 package gates; disposable branded Chrome/Edge launch attempts captured exact bounded failures | Chrome service worker and Edge persistent context timed out; Firefox absent; first/second open, install/provider/account/sign/tx/hosting/public/production/store remain false |
