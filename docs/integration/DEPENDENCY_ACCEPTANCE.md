...
| Web/PWA/Extensions | `a3059db5d7e08e60bfcdf6b590d8217d211e008a` | Prior Edge/canonical fail-close evidence plus bundled Chromium-compatible Arabic/RTL/Dark preference persistence and invalid-record reset across second launch | bundled runtime is not branded-browser/PWA installation; no canonical account/sign/tx success, Chrome live provider, hosting/production/store remain false |
