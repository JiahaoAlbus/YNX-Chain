...
| YNX 20 | Object Store, object/version metadata, retention, delete and restore | Local/remote adapters with hash validation; schema v2 | Pending | Accepted remote schema, outage behavior and restore drill |
...
| YNX 30 | Security/SRE/release/backup/artifact gate | Targeted unit/race/vet/build checks pass | Pending | Release policy, SBOM/provenance, scans, backup/restore and public gate |
