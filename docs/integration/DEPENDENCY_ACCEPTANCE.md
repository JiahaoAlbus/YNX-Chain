...
| Desktop/CLI/SDK | `f27b5867227e172756d4a8c3638905c668874f33` | TypeScript 0.2.1 evidence plus exact central handoff contract; prior desktop/CLI and Go source consumer evidence retained | Handoff explicitly keeps formal Go archive, central/public/hosted/production/store false |
