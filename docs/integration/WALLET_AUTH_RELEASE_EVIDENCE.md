...
The frozen checkpoints are Core `774a1f756890043e88626d13b6c9679a2ad6d288`, Web `7d569d1babb85e6d28bb6bfc3b3c0c5fd828255d`, Android `4739a60e1fa0e3d0b6862e129330f9e9ca202887`, iOS/macOS `04450cff296511018447e5d4886803081149f596`, and Desktop/CLI/SDK `ddab97ee88e927558f87eddc2d4a61a09a5bdc80`. The Desktop checkpoint proves a macOS 15 Intel CLI lifecycle in native CI, including exact `0x1917`, temporary device proof, fail-close and artifact re-download. The 5,218,699-byte gzip has SHA-256 `122e3bceae5854de9721b1e18e75bef5ce584985d0818a06fb160d9bac72aecf`; it is unsigned, while only the temporary installed copy was ad-hoc signed.

Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the recorded macOS x64 handoff and Fedora Desktop successors remain queued. Public/hosted/production/store truth is unchanged.
