...
External Chain Core contract version `1.30.0` is identity-bound at implementation `aab0b6b9fc28b40ef8715214cd95360734db4c48` and contract commit `3bcae14f9d42fd2fbcce2211a7c51a737f8ed464`. Direct Owner object readback verified parent `aab0b6b9…`, tree `aa84d7b1…`, contract blob `6df6d0e7…`, content SHA-256 `ad0c6fbd…`, package `3de79e37…`, readiness `1adbcd66…`, and the 141,977,791-byte bundle SHA-256 `49603252…8162`. v30 binds local authenticated SafetyStore v2 and ValidatorVoteSigner evidence. Replay of a valid older signed snapshot remains possible without an unprovided trusted external monotonic anchor; signer custody and public runtime are also unproved. This is dependency-contract acceptance only and promotes no source integration or deployment gate.
