...
The frozen checkpoints are Core `0c747c6030b5a475a1f12dc7e57345555c23055d`, Web `7d569d1babb85e6d28bb6bfc3b3c0c5fd828255d`, Android `f1edbec46ad4300beec406873b03db2da7c72e4b`, iOS/macOS `50d3b2e2c5bd77456b84f348c48fa4a9ed76b5b3`, and Desktop/CLI/SDK `6856bf41f79ffdb0a637d7e1cad11e6931158d67`. Core deployment-verifier evidence is local and mocked; its `publicExecution.performed` and every deployment claim are false. Android source `bc2a0712e0dc828e3c157eff0e703e236bed48fc` proves pending→delivered recovery with exact binding, no re-sign, and retained replay protection; device callback delivery remains false.

macOS arm64 CLI run 31776448279 proves native-CI install/upgrade, cold/second start, frozen Auth vector, ephemeral device proof without key persistence, exact `0x1917`, fail-close, uninstall and connector rehash. The gzip is 4,904,463 bytes with SHA-256 `21db36f1c80d4e88520918de141a7f71921817799270ff671db88179023b5591`; commit `6856bf41f79ffdb0a637d7e1cad11e6931158d67` additionally proves an exact HTTP 200 full download from a public Vercel Blob store. That hostname is not an official YNX domain and the website registry/rewrite is absent, so `downloadHosted`, `deployedPublic` and production signing remain false.
