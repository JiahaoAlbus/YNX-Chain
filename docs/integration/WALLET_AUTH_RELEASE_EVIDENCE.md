...
The frozen checkpoints are Core `774a1f756890043e88626d13b6c9679a2ad6d288`, Web `7d569d1babb85e6d28bb6bfc3b3c0c5fd828255d`, Android `4739a60e1fa0e3d0b6862e129330f9e9ca202887`, iOS/macOS `04450cff296511018447e5d4886803081149f596`, and Desktop/CLI/SDK `02acde92b34ba555ed55f5b512d3dd8a48c1412e`. Run 31774674583 directly proves Fedora 42 arm64 DNF dependency resolution and RPM postinstall/postuninstall scripts plus install/upgrade, sandbox state, GUI cold/second launch, exact `0x1917`, fail-close, uninstall and artifact re-download. The RPM is 81,243,557 bytes with SHA-256 `f520f138d2decfa8c33d721220482f6cf5f24b6a503fb381e484c56fcc7c56d2`; it remains unsigned and unhosted, and rollback is not claimed.

Android `6f096503793218ddfd9b3b1cd6403a07d4fafb97` and the Fedora Desktop handoff remain queued. Unknown rollback descendants are not consumed. Public/hosted/production/store truth is unchanged.
