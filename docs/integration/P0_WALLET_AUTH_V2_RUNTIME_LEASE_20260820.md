...
Lease `P0-WALLET-CONNECTIVITY-2026-08-wallet-auth-v2-runtime-lease-20260820T120255Z` is single-use, owned by Wallet Protocol, executable only by the Wallet/Auth Gateway runtime deployment owner, and expires at `2026-08-20T14:02:55Z`. It authorizes only the exact existing `wallet-auth.ynxweb4.com` runtime transaction. It does not authorize a whole-tree merge, registry mutation, another service, Wallet UI, platform, product, Website, SDK or installed-client action.
