...
The original acceptance commit `401eee474ac188fed1fc1e6089d6a0f9e1250651` lost the authoritative control-plane race and is superseded. This record is re-materialized on latest authoritative base `5c81dbfc763039fc6be56f814fde20b77ee7117f` without overwriting concurrent control-plane files, including the Finance and Explorer/Monitor slices that advanced after `3546263a…`.

The execution lease is `release/integration/p0-wallet-protocol-execution-lease.json`. Lease `P0-WALLET-CONNECTIVITY-2026-08-runtime-lease-20260820T091246Z` supersedes the earlier 090524Z lease. It is owned by `wallet-protocol`, executed only by `wallet-auth-gateway-runtime-owner` through `codex/p0-wallet-protocol-integration-20260820`, expires at `2026-08-20T11:12:46Z`, and authorizes one rollback-protected Wallet/Auth Gateway runtime transaction. It excludes Wallet UI/platform packages, other products, Chain Core, website changes and unrelated service restarts.
