...
- Original evidence: `release/economics/operator-inputs.request.json` and `release/economics/product-release.json` retain all shared-Testnet acceptance booleans as false.
...
- Original evidence: `release/economics/product-release.json`, `release/economics/public-product-metadata.json`, and `release/economics-testnet-cli-artifact.json` explicitly preserve production and public states as false.
