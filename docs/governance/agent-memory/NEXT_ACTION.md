...
4. Merge only after required checks pass; then record the merge SHA and request Product 29 acceptance against `release/integration/governance-contract.json` and `docs/governance/CROSS_PRODUCT_TEST_VECTORS.json`.
