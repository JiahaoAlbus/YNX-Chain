...
- Cross-product vectors: `docs/data-fabric/integration/CROSS_PRODUCT_TEST_VECTORS.json`
- Dependency acceptance: `docs/data-fabric/integration/DEPENDENCY_ACCEPTANCE.md`
