...
Current single action: commit and push the release-archive custody hardening, deploy that exact control-plane commit through the reviewed restricted path, and rerun four-role release/checksum convergence plus the strictly read-only production rehearsal. Only after the new exact-commit evidence passes may an operator generate the deliberately unapproved packet with `make public-bft-freeze-rehearsal-approval-template` for independent review. Release predeploy backups ran for `f35f2ba49145`, but the separate BFT transaction backup, freeze/unfreeze, and recovery transaction has not run on production. Do not create the public marker without a separately completed mode-`0600` approval bound to the exact transaction. Stop before pausing authoritative production or changing public ingress.

Current authoritative baseline (verified 2026-07-13): deployed runtime release `f35f2ba49145` is live on all four roles. All roles matched release-manifest SHA-256 `5136344132be0271961ae0371035e3fbf5451e5d119e0ef11f97a0a361432ab8` and daemon SHA-256 `b417cffaf68d810b9854cfae6458fdad9b5c8e3355553c76bae98b6c24ab2470`; fixed height `75756` matched hash `aecdbcf0b2e5772f1198bc033ac1335eb25a7dd4f2ff3bd06741087ff69afb6c` on all four roles. The exact-release Singapore smoke also passed all chain and mutable ecosystem flows except provider-backed AI generation and two legacy Web4 identity checks. The read-only rehearsal passed at `tmp/public-bft-production-rehearsal/rehearsal-f35f2ba49145-20260713T054727Z` with no remote mutation or ingress change. The repository release-archive mode/checksum/cleanup hardening is newer than this live baseline and must be deployed before any freeze packet is generated. This route is not independent third-party proof.
