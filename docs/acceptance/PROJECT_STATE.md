...
- State snapshot baseline commit: `563fe1f Commit sponsored resource pools to AppHash` (implementation baseline)
- Last pushed commit (implementation): `563fe1f36918a3c614f657ac43584c4114ae7635`
- Chain repo state: `/Users/huangjiahao/Desktop/YNX Chain`, branch `main`, remote `https://github.com/JiahaoAlbus/YNX-Chain.git`; the BFT sponsored resource-pool implementation commit is pushed and this acceptance update records its local verified boundary.
...
- Make the JavaScript and Python SDK release process reproducible and independently verifiable with a canonical release manifest, deterministic package artifacts, cryptographic digests, owner-supplied detached-signature verification, and clean-environment consumer tests. Do not publish to npm or PyPI without owner approval and registry credentials, and do not describe a locally verified package as publicly published.
