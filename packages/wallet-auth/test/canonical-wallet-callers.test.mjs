...
import { scanRepository, scanWalletCallerText } from "../scripts/verify-canonical-wallet-callers.mjs";
...
test("canonical caller scanner requires the shared builder instead of URI concatenation", () => {
  ...
  ), [{ path: "apps/example/src/wallet.ts", line: 1, code: "MANUAL_AUTHORIZE_URI" }]);
  assert.deepEqual(scanWalletCallerText(
    "apps/example/src/wallet.ts",
