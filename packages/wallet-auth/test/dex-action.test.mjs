...
function request(action="dex_swap_exact_input",payload={poolId:"ynxt-yusd",assetIn:"ynxt",amountIn:1000,minAmountOut:1900,deadlineUnix:1786331040},overrides={}){return {version:"1",chainId:6423,productClientId:"ynx-dex-web-v1",bundleId:"com.ynxweb4.dex.web",callback:"https://dex.ynxweb4.com/wallet-action/callback",sessionBinding:"a".repeat(64),account:walletIdentity(SECRET).account,nonce:1,action,payload,quote,issuedAt:NOW.toISOString(),expiresAt:"2026-08-10T03:05:00.000Z",...overrides}}

test("DEX Wallet signs exact-input, exact-output, add and remove liquidity actions",()=>{
  const cases=[
    request(),
    request("dex_swap_exact_output",{poolId:"ynxt-yusd",assetOut:"yusd-test",amountOut:1900,maxAmountIn:1100,deadlineUnix:1786331040}),
    request("dex_liquidity_add",{poolId:"ynxt-yusd",amount0:1000,amount1:2000,minShares:1300,deadlineUnix:1786331040}),
    request("dex_liquidity_remove",{poolId:"ynxt-yusd",shares:500,minAmount0:300,minAmount1:600,deadlineUnix:1786331040}),
  ];
