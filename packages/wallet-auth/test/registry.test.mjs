...
test("central registry contains 26 unique, least-privilege products with Creator Studio and accepted products approved", () => {
  ...
  assert.deepEqual(approved.map((product) => product.productId), ["creator-studio", "exchange", "finance", "quant", "shop"]);
  ...
  assert.deepEqual(centralRegistrationByProduct(registry, "creator-studio").callbacks, ["https://web4.ynxweb4.com/video/studio/wallet-auth/callback"]);
});
