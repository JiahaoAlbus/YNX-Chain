...
function identifier(value,label){return pattern(value,label,/^[a-z0-9][a-z0-9._:-]{2,63}$/)}
function asset(value,label){return pattern(value,label,/^(ynxt|[a-z0-9][a-z0-9._:-]{2,63})$/)}
