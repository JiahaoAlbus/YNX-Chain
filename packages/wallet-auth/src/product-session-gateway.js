...
function retiredBinding(registry, item) {
...
function retiredCachedResponse(registry, item) {
  try { return retiredBinding(registry, JSON.parse(item.responseBody).result); }
  catch { return true; }
}
