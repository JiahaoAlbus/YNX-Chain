...
export declare function productSessionStateToStandardWalletPrivateServiceEvent(productSessionState:Readonly<Record<string,unknown>>):Readonly<{type:"PRIVATE_SESSION_CONNECTING"}>|Readonly<{type:"PRIVATE_SESSION_READY"}>|Readonly<{type:"PRIVATE_SESSION_DEGRADED";code:"GATEWAY_UNAVAILABLE"|"ROUTE_NOT_MOUNTED"}>|null;
export declare function applyProductSessionStateToStandardWallet(standardWalletState:StandardWalletConnectState,productSessionState:Readonly<Record<string,unknown>>):StandardWalletConnectState;
