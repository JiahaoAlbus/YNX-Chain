...
export type DexQuote=Readonly<{poolBlockHeight:number;poolUpdatedAt:string;asset0:string;asset1:string;reserve0:number;reserve1:number;feeBps:number;expectedAmount:number}>;
