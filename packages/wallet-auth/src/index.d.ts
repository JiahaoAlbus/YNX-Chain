...
export type AuthorizationRejection = Readonly<{version:"2";decision:"rejected";requestDigest:string;nonce:string;chainId:"ynx_6423-1";requestingProduct:string;productClientId:string;bundleId:string;callback:string;decisionCode:"USER_REJECTED";rejectedAt:string;authorityGranted:false;grantedScopes:readonly []}>;
