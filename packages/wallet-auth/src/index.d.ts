...
export type CardProviderDetails = Readonly<{productCardId:string;principalOwner:string;provider:string;programId:string;environment:"TEST";externalAccountBindingHash:string;appChain:"ynx_6423-1";fundingNetwork:string;fundingAssetId:string;tokenContract:string|null;decimals:number;testSpendingLimitMinor:string;cardAccountCurrency:string;minorUnitDigits:number;termsVersion:string;termsHash:string;riskVersion:string;riskHash:string;feeDisclosureVersion:string;feeDisclosureText:string;feeDisclosureHash:string;idempotencyKey:string}>;
export type CardProviderChallenge = Readonly<{id:string;applicationId:string;owner:string;chainId:"0x1917";purpose:"create-provider-test-card";payloadHash:string;requestBindingHash:string;nonce:string;issuedAt:string;expiresAt:string}>;
export type SignedCardApplicationApproval = Readonly<{version:"1";productId:"card";challenge:CardApplicationChallenge;details:CardApplicationDetails;account:string;accountPublicKey:string;issuedAt:string;expiresAt:string;signature:string}>|Readonly<{version:"2";productId:"card";challenge:CardProviderChallenge;details:CardProviderDetails;account:string;accountPublicKey:string;issuedAt:string;expiresAt:string;signature:string}>;
...
export type FinanceOrderOpaqueClaim=Readonly<{version:"2";productId:"finance";origin:"https://finance.ynxweb4.com";chainId:"0x1917";action:"claim-order-review";account:string;accountPublicKey:string;ticketHash:string;nonce:string;issuedAt:string;expiresAt:string;signature:string}>;
export type FinanceOrderOpaqueReject=Readonly<{version:"2";productId:"finance";origin:"https://finance.ynxweb4.com";chainId:"0x1917";action:"reject";account:string;accountPublicKey:string;ticketHash:string;requestId:string;challengeId:string;orderHash:string;callbackStateHash:string;issuedAt:string;expiresAt:string;signature:string}>;
export declare const FINANCE_ORDER_OPAQUE_LAUNCH_ROUTE:"ynxwallet://finance-order-approval";
export declare const FINANCE_ORDER_OPAQUE_CALLBACK:"https://finance.ynxweb4.com/wallet-auth/callback";
...
export type FinanceOrderStateBinding="sha256-v2"|"raw-v1-random32";
export declare const FINANCE_ORDER_STATE_BINDING_SHA256:"sha256-v2";
export declare const FINANCE_ORDER_STATE_BINDING_LEGACY_RAW:"raw-v1-random32";
...
export declare function financeOrderOpaqueClaimMessage(unsigned:unknown):string;
export declare function createSignedFinanceOrderOpaqueClaim(input:Readonly<{ticket:string;accountSecret:string;nonce:string;issuedAt:string;expiresAt:string}>):FinanceOrderOpaqueClaim;
export declare function verifyFinanceOrderOpaqueClaim(proof:unknown,expected:Readonly<{ticket:string;account:string;accountPublicKey:string}>,at:Date):Readonly<{verified:true;ticketHash:string;account:string;nonce:string;expiresAt:string}>;
export declare function createSignedFinanceOrderOpaqueReject(input:Readonly<{ticket:string;challenge:FinanceOrderApprovalUnsigned}>,at:Date,accountSecret:string):FinanceOrderOpaqueReject;
...
export declare function createFinanceOrderOpaqueCallbackURL(input:Readonly<{code:string;state:string;requestId:string;callbackStateHash:string}>,binding?:FinanceOrderStateBinding):string;
export declare function parseFinanceOrderOpaqueCallbackURL(url:string,expected:Readonly<{requestId:string;callbackStateHash:string}>,binding?:FinanceOrderStateBinding):Readonly<{code:string;state:string;requestId:string}>;
...
export declare function parseFinanceOrderOpaqueCompleteResponse(input:unknown,expected:Readonly<{ticket:string;challenge:FinanceOrderApprovalUnsigned}>,binding?:FinanceOrderStateBinding):Readonly<{version:"2";ticketHash:string;requestId:string;status:"stored";code:string;state:string;expiresAt:string;serverTime:string;callbackURL:string}>;
