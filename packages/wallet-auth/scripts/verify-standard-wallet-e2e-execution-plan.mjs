...
const expectedFirstWaveAuditDomains = ["merchant-console", "social", "seller-console", "trust-center", "search", "mail", "ai", "cloud", "resource-market", "governance", "music", "bridge", "browser", "docs", "explorer", "monitor", "card"];
