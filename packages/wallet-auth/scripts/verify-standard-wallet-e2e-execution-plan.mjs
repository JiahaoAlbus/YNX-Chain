...
const expectedFirstWaveAuditDomains = ["merchant-console", "social", "pay", "seller-console", "trust-center", "search", "mail", "ai", "cloud", "resource-market", "governance", "music", "bridge", "browser", "docs", "explorer", "monitor", "card"];
...
if (auditFacts.social?.reportedSourceCommit !== "ecffe336a3a380e8b13b6a7926720efb1bfe4ae2" || auditFacts.social?.reportedSourceTree !== "a7289a70cb7464b4debdb24163f93572194681eb" || auditFacts.social?.reportedEvidenceCommit !== "f0f1120000302a035b5f2dd6df5ff973457b36" || auditFacts.social?.ephemeralArtifactBytes !== 921443 || auditFacts.social?.ephemeralArtifactSha256 !== "ff94c7ab3b93b6f953b2ec25af896a6408219809f9df9ea59933f53eebb1235e" || auditFacts.social?.ephemeralArtifactAccepted !== false || auditFacts.social?.durableArtifactBlocker !== "CENTRAL_DURABLE_ARTIFACT_URI_DIGEST_ACCEPTANCE_REQUIRED" || auditFacts.social?.sourceBoundPublic !== false || auditFacts.social?.currentPublicGuestObservation?.accountAccessRequested !== false) findings.push("Social ephemeral-artifact routing boundary drift");
