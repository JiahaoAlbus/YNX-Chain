...
export interface BridgeProviderRegistryEntry {
  ...
  routeSupportEvidence?: string | null;
  agreementEvidence?: string | null;
  operationalReviewEvidence?: string | null;
  outageMode?: string;
  routeSupportVerified?: boolean;
...
export interface BridgeProviderRegistry {
  ...
  asOf: string;
  coverage: "configured-provider-identities-and-routes-only-no-live-provider-session-commercial-rights-or-independent-incident-history" | "configured-provider-routes-and-cached-live-api-health-no-executable-route-or-independent-incident-history";
