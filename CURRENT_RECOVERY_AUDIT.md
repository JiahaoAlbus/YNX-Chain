...
- Chain-level Smart Account, schemas, SDK surfaces, and fee invariants remain local implementation evidence. StrategyMandate, StrategyVault, and the validator delegation/unbonding/withdrawal lifecycle are integrated into branch-local committed-state v10, ABCI execution/query, and BFT Gateway code with local/race evidence; none of these primitives is deployed on the authoritative public runtime.
