...
if [[ "$YNX_BRIDGE_DEPLOY_ENABLED" == "true" ]]; then
  bridge_required=(YNX_BRIDGE_API_KEY YNX_BRIDGE_GATEWAY_API_KEY YNX_BRIDGE_RELAYERS_JSON YNX_BRIDGE_ROUTE_POLICIES_JSON YNX_BRIDGE_RELAYER_THRESHOLD YNX_BRIDGE_HTTP_ADDR YNX_BRIDGE_RATE_LIMIT_WINDOW YNX_BRIDGE_RATE_LIMIT_MAX YNX_BRIDGE_RETENTION_PERIOD)
...
ynx_write_kv_env "$work/config/ynx-bridged.env" \
  YNX_BRIDGE_DEPLOY_ENABLED YNX_BRIDGE_API_KEY YNX_BRIDGE_GATEWAY_API_KEY YNX_BRIDGE_RELAYERS_JSON YNX_BRIDGE_ROUTE_POLICIES_JSON \
