...
grep -Fq "YNX_APP_GATEWAY_WALLET_URL=http://127.0.0.1:6438" "$release_dir/config/ynx-app-gatewayd.env" || { echo "App Gateway env missing loopback Wallet upstream"; exit 1; }
