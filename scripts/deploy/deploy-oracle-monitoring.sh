...
sudo chown "$(id -u):$(id -g)" "$work/ynx-alerts.yml"
sed \
  -e "s#/etc/ynx/prometheus/ynx-alerts.yml#$work/ynx-alerts.yml#" \
  -e "s#/etc/ynx/prometheus/oracle-alerts.yml#$work/oracle-alerts.yml#" \
