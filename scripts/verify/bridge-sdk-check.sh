...
node -e 'const p=require("./sdk/bridge/package.json");if(p.private!==true||p.name!=="@ynx-chain/bridge-sdk"||p.version!=="0.3.0"||p.types!=="./index.d.ts"||p.files.join(",")!=="README.md,index.js,index.d.ts"||p.exports?.["."]?.types!=="./index.d.ts")process.exit(1)'
