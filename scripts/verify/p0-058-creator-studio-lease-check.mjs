...
assert.equal(lease.status,"ACTIVE_BOUNDED_CREATOR_STUDIO_SOURCE_ONLY");
...
console.log("PASS P0-058 is a bounded Creator Studio source-only Light slice while P0-057 remains NO_GO");
