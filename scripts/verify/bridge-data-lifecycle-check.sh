...
echo "bridge-data-lifecycle-check passed: v2/v3/v4/v5-to-v6 migration, exact reconciliation replay, lifecycle and exposure evidence, export, active safety hold, retention, idempotent identity redaction, restart, tamper rejection, and cessation runbook"
