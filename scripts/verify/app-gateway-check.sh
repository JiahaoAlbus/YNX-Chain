...
echo "app-gateway-check passed: ynx1 ownership proof, browser/native binding separation, persistent hashed sessions, replay/revocation controls, protected Bridge Wallet review context and Chat/Square/Pay routes, public bounded reads, exact origins, CORS, bounds, and direct-service denial"
