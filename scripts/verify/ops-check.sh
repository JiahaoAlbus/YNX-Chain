...
grep -Fq "ynx-trustd" "$out" || { echo "primary Trust Gateway service not covered"; exit 1; }
grep -Fq "ynx-resourced" "$out" || { echo "primary Resource Gateway service not covered"; exit 1; }
