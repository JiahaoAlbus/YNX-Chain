...
jq empty release/governance/product-release.json release/governance/public-product-metadata.json .ai-bridge/full-goal-coverage.json release/integration/governance-contract.json docs/integration/CROSS_PRODUCT_TEST_VECTORS.json release/integration/governance-app-gateway.manifest.json release/integration/governance-app-gateway.schema.json release/integration/governance-bft.manifest.json release/integration/governance-bft.schema.json release/integration/governance-bft-test-vectors.json
...
if scan_text insensitive 'TODO|FIXME|Placeholder|Coming soon|example\.com|Fake Balance|Fake User|Fake Transaction|Fake Price|Fake Revenue|Fake APY|Fake Liquidity|Fake Provider|Fake Health|Hard-coded Success|No-op Button' apps/governance internal/governance cmd/ynx-governance-state cmd/ynx-governanced docs/governance release/governance release/integration/governance-app-gateway.manifest.json release/integration/governance-app-gateway.schema.json release/integration/governance-bft.manifest.json release/integration/governance-bft.schema.json release/integration/governance-bft-test-vectors.json infra/systemd/ynx-governanced.example.service infra/docker/ynx-governanced.Dockerfile; then
...
if scan_text sensitive '(BEGIN (RSA|EC|OPENSSH|PRIVATE) KEY|AKIA[0-9A-Z]{16}|ghp_[A-Za-z0-9]{36}|sk-[A-Za-z0-9]{32,})' apps/governance cmd/ynx-governance-state cmd/ynx-governanced internal/governance docs/governance release/governance release/integration/governance-app-gateway.manifest.json release/integration/governance-app-gateway.schema.json release/integration/governance-bft.manifest.json release/integration/governance-bft.schema.json release/integration/governance-bft-test-vectors.json infra/systemd/ynx-governanced.example.service infra/docker/ynx-governanced.Dockerfile; then
