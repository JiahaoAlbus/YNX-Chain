...
for target in 127.0.0.1:6420 10.77.42.2:6420 10.77.42.3:6420 10.77.42.4:6420 127.0.0.1:6427; do
...
echo "authoritative-monitoring-check passed: four Chain targets, one Explorer target and a restricted listener are configured"
