...
echo "bridge-api-check passed: truthful product status, fail-closed route and asset catalogs, persistent lifecycle and relayer evidence revalidation, replay/conflict, limits/delay, pause/resume, reconciliation/transparency, data export/retention hold, auth, tracing, truthful metrics, and mode-0600 state"
