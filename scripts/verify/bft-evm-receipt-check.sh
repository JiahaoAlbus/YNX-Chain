...
echo "bft-evm-receipt-check passed: committed transaction lookup, receipt gas/index/block evidence, zero-log truth boundary, bounded filters, and fail-closed validation are verified while capability promotion remains blocked"
