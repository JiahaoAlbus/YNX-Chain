...
if (manifest.schemaVersion !== 2 || manifest.runtimeSchemaVersion !== 7 || manifest.stateMachineVersion !== expectedStateMachine || manifest.currentIntegrationState !== "testnet-app-gateway-integrated-route-execution-disabled" || !commitPattern.test(manifest.sourceCommit)) fail("manifest integration state is invalid");
