...
function validatePackages(packages, artifactDir, sourceRoot) {
  ...
  validatePackage(byID.get("javascript"), {
    ...
    name: "@ynx-chain/sdk",
    registry: "npm",
    sourcePaths: ["sdk/js/index.js", "sdk/js/package.json", "sdk/js/wallet.js", "sdk/js/ynx-testnet.js", "sdk/js/testnet-endpoints.js", "sdk/js/endpoint-authority.js", "sdk/js/endpoint-authority-bundle.js"],
...
function validateExpectedArchiveFiles(entry) {
  ...
  if (entry.id === "javascript") {
    expected = ["package/index.js", "package/package.json", "package/wallet.js", "package/ynx-testnet.js", "package/testnet-endpoints.js", "package/endpoint-authority.js", "package/endpoint-authority-bundle.js"].sort();
  } else {
