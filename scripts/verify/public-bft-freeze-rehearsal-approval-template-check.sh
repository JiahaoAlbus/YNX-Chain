...
echo "public-bft-freeze-rehearsal-approval-template-check passed: generated packet is mode-restricted, current-commit-bound, explicitly unapproved, and forbids pause/ingress/cutover"
