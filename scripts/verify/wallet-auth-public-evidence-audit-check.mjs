...
if (audit.walletWebCompanionCoreRuntimeCandidate?.commit !== "bb2d9d4f1e6656b6984c19879df4ec1a58cd10c5" || audit.walletWebCompanionCoreRuntimeCandidate?.contractBlob !== "abf3ed2525a5252a2d6ada343c77485526986419" || audit.walletWebCompanionCoreRuntimeCandidate?.registryBlob !== "a59f7aba930e6643363e7c0b5bb27028c1ecc43a" || audit.walletWebCompanionCoreRuntimeCandidate?.productId !== "wallet-web-companion" || audit.walletWebCompanionCoreRuntimeCandidate?.clientId !== "ynx-wallet-web-companion-v1" || audit.walletWebCompanionCoreRuntimeCandidate?.callback !== "https://www.ynxweb4.com/dapp/wallet/wallet-auth/callback" || audit.walletWebCompanionCoreRuntimeCandidate?.approvedAndEnabledLocalRegistry !== true || audit.walletWebCompanionCoreRuntimeCandidate?.genericNativeWalletEntryEnabled !== false || audit.walletWebCompanionCoreRuntimeCandidate?.walletAuthTestsPassed !== 318 || audit.walletWebCompanionCoreRuntimeCandidate?.walletAppTestsPassed !== 40 || audit.walletWebCompanionCoreRuntimeCandidate?.restartExpiryRevokeCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.senderConstrainedRevokeBeforeProtectedStateClear !== true || audit.walletWebCompanionCoreRuntimeCandidate?.revokeReplayRejectedWithZeroMutation !== true || audit.walletWebCompanionCoreRuntimeCandidate?.gatewayRestartRestoreVerifiedLocal !== true || audit.walletWebCompanionCoreRuntimeCandidate?.expiryFailsClosedWithoutNetworkCall !== true || audit.walletWebCompanionCoreRuntimeCandidate?.revokeOutageRetainsProtectedStateForRetry !== true) fail("Wallet Web companion core runtime candidate mismatch");
