...
if (audit.productWalletConnectionFactoryBoundary?.commit !== "cdf56db727158c55a36f9ae3cad316b243149a7b" || audit.productWalletConnectionFactoryBoundary?.handoffBlob !== "9dd9b7987c06d6c8ca27fe7a19a0a46d7d7c2475" || audit.productWalletConnectionFactoryBoundary?.factory !== "createProductWalletConnection" || audit.productWalletConnectionFactoryBoundary?.factoryOwnsCryptographicNonceAndState !== true || audit.productWalletConnectionFactoryBoundary?.factoryOwnsSystemTime !== true || audit.productWalletConnectionFactoryBoundary?.concurrentUniqueNonceAndStateCount !== 120 || audit.productWalletConnectionFactoryBoundary?.legacyRequiresSameProductPlatformRegistryBinding !== true || audit.productWalletConnectionFactoryBoundary?.unknownOrCrossProductLegacyRejected !== true || audit.productWalletConnectionFactoryBoundary?.walletAuthTestsPassed !== 211) fail("product Wallet connection factory boundary mismatch");
...
if (audit.walletWebCompanionCoreRuntimeCandidate?.commit !== "a46d5456432550072fe7eaea747866d6fd966a4d" || audit.walletWebCompanionCoreRuntimeCandidate?.contractBlob !== "9bffb1530ba71db26b04650035c2515d402ea8ec" || audit.walletWebCompanionCoreRuntimeCandidate?.registryBlob !== "a59f7aba930e6643363e7c0b5bb27028c1ecc43a" || audit.walletWebCompanionCoreRuntimeCandidate?.productId !== "wallet-web-companion" || audit.walletWebCompanionCoreRuntimeCandidate?.clientId !== "ynx-wallet-web-companion-v1" || audit.walletWebCompanionCoreRuntimeCandidate?.callback !== "https://www.ynxweb4.com/dapp/wallet/wallet-auth/callback" || audit.walletWebCompanionCoreRuntimeCandidate?.approvedAndEnabledLocalRegistry !== true || audit.walletWebCompanionCoreRuntimeCandidate?.genericNativeWalletEntryEnabled !== false || audit.walletWebCompanionCoreRuntimeCandidate?.walletAuthTestsPassed !== 315 || audit.walletWebCompanionCoreRuntimeCandidate?.walletAppTestsPassed !== 40) fail("Wallet Web companion core runtime candidate mismatch");
