...
if (audit.walletWebCompanionCoreRuntimeCandidate?.commit !== "8a7accfeec8b12d85f35f021a10fa1b1da94bd07" || audit.walletWebCompanionCoreRuntimeCandidate?.contractBlob !== "2fb6d1a165927c987df8d60bbb9dbd692d0544b1" || audit.walletWebCompanionCoreRuntimeCandidate?.registryBlob !== "a59f7aba930e6643363e7c0b5bb27028c1ecc43a" || audit.walletWebCompanionCoreRuntimeCandidate?.productId !== "wallet-web-companion" || audit.walletWebCompanionCoreRuntimeCandidate?.clientId !== "ynx-wallet-web-companion-v1" || audit.walletWebCompanionCoreRuntimeCandidate?.callback !== "https://www.ynxweb4.com/dapp/wallet/wallet-auth/callback" || audit.walletWebCompanionCoreRuntimeCandidate?.approvedAndEnabledLocalRegistry !== true || audit.walletWebCompanionCoreRuntimeCandidate?.genericNativeWalletEntryEnabled !== false || audit.walletWebCompanionCoreRuntimeCandidate?.walletAuthTestsPassed !== 319 || audit.walletWebCompanionCoreRuntimeCandidate?.walletAppTestsPassed !== 40 || audit.walletWebCompanionCoreRuntimeCandidate?.restartExpiryRevokeCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.senderConstrainedRevokeBeforeProtectedStateClear !== true || audit.walletWebCompanionCoreRuntimeCandidate?.revokeReplayRejectedWithZeroMutation !== true || audit.walletWebCompanionCoreRuntimeCandidate?.gatewayRestartRestoreVerifiedLocal !== true || audit.walletWebCompanionCoreRuntimeCandidate?.expiryFailsClosedWithoutNetworkCall !== true || audit.walletWebCompanionCoreRuntimeCandidate?.revokeOutageRetainsProtectedStateForRetry !== true || audit.walletWebCompanionCoreRuntimeCandidate?.concurrentDisconnectLinearizedCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.concurrentDisconnectExactlyOneAuthoritativeRevoke !== true || audit.walletWebCompanionCoreRuntimeCandidate?.concurrentDisconnectCallersShareResult !== true || audit.walletWebCompanionCoreRuntimeCandidate?.protectedStateClearedOnlyAfterRevokeConfirmation !== true) fail("Wallet Web companion core runtime candidate mismatch");
