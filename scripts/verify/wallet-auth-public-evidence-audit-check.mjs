...
if (!productSessionV2 || productSessionV2.cors !== true || productSessionV2.optionsVerified !== true || productSessionV2.registeredOriginOnly !== true || productSessionV2.mobileReachable !== false || productSessionV2.socialOriginAllowed !== true || productSessionV2.socialOriginStatus !== 204 || productSessionV2.webCompanionOriginAllowed !== false || productSessionV2.webCompanionOriginStatus !== 403 || productSessionV2.webCompanionOriginError !== "ORIGIN_NOT_ALLOWED" || productSessionV2.wildcardOriginAllowed !== false || productSessionV2.credentialsAllowed !== false) fail("Product Session v2 CORS/mobile boundary drifted");
...
if (audit.walletWebCompanionCoreRuntimeCandidate?.commit !== "d5f252e90b8e7a69dfddc71e64b872a7e4482f47" || audit.walletWebCompanionCoreRuntimeCandidate?.contractBlob !== "65850415eeea271c0eeb4e4030aea0819d47f7ac" || audit.walletWebCompanionCoreRuntimeCandidate?.registryBlob !== "a59f7aba930e6643363e7c0b5bb27028c1ecc43a" || audit.walletWebCompanionCoreRuntimeCandidate?.productId !== "wallet-web-companion" || audit.walletWebCompanionCoreRuntimeCandidate?.clientId !== "ynx-wallet-web-companion-v1" || audit.walletWebCompanionCoreRuntimeCandidate?.callback !== "https://www.ynxweb4.com/dapp/wallet/wallet-auth/callback" || audit.walletWebCompanionCoreRuntimeCandidate?.approvedAndEnabledLocalRegistry !== true || audit.walletWebCompanionCoreRuntimeCandidate?.genericNativeWalletEntryEnabled !== false || audit.walletWebCompanionCoreRuntimeCandidate?.walletAuthTestsPassed !== 330 || audit.walletWebCompanionCoreRuntimeCandidate?.walletAppTestsPassed !== 40 || audit.walletWebCompanionCoreRuntimeCandidate?.postCompletionOutageRevokeCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.networkUnavailableClientRetainsExactProtectedSession !== true || audit.walletWebCompanionCoreRuntimeCandidate?.disconnectRequiresRevokeBeforeProtectedStateClear !== true || audit.walletWebCompanionCoreRuntimeCandidate?.publicRuntimeSource !== "577f81202a85ff7314dd862f60aa337b0f2fd1f1" || audit.walletWebCompanionCoreRuntimeCandidate?.publicSocialOriginStatus !== 204 || audit.walletWebCompanionCoreRuntimeCandidate?.publicSocialOriginAllowed !== true || audit.walletWebCompanionCoreRuntimeCandidate?.publicWebCompanionOriginStatus !== 403 || audit.walletWebCompanionCoreRuntimeCandidate?.publicWebCompanionOriginError !== "ORIGIN_NOT_ALLOWED" || audit.walletWebCompanionCoreRuntimeCandidate?.publicWebCompanionOriginAllowed !== false || audit.walletWebCompanionCoreRuntimeCandidate?.finalClientDisconnectedWithoutSessionResurrection !== true || audit.walletWebCompanionCoreRuntimeCandidate?.restoreDisconnectNoResurrectionCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.restoreAndRetryRecoverySingleFlight !== true || audit.walletWebCompanionCoreRuntimeCandidate?.disconnectWaitsForCapturedRecoveryTransaction !== true || audit.walletWebCompanionCoreRuntimeCandidate?.restoreDisconnectExactlyOneRevokedSession !== true || audit.walletWebCompanionCoreRuntimeCandidate?.restoreDisconnectAutoReconnectPrevented !== true || audit.walletWebCompanionCoreRuntimeCandidate?.consumedRouterSource !== "48ca620105d07a78b1abb8bd02648ed7b0fe4772" || audit.walletWebCompanionCoreRuntimeCandidate?.networkEpochCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.completionNetworkTransitionProtectedCandidate !== true || audit.walletWebCompanionCoreRuntimeCandidate?.issuedSessionProtectedBeforeNetworkTransitionReturns !== true || audit.walletWebCompanionCoreRuntimeCandidate?.retryCanIntrospectIssuedSessionAfterNetworkTransition !== true || audit.walletWebCompanionCoreRuntimeCandidate?.disconnectCanRevokeIssuedSessionAfterNetworkTransition !== true || audit.walletWebCompanionCoreRuntimeCandidate?.secureSignerReconciliationPending !== true) fail("Wallet Web companion core runtime candidate mismatch");
...
if (audit.walletWebCompanion6441DeploymentAcceptance?.commit !== "a731d67b474650c0e6a7ddcf1aa4464f714484f0" || audit.walletWebCompanion6441DeploymentAcceptance?.handoffBlob !== "9fa31baa81bbdab08e3d83e8e0f76e3d5b34b07a" || audit.walletWebCompanion6441DeploymentAcceptance?.candidateSource !== "f5e0ef319b0fe8ff0993021e435fdc6627b0d931" || audit.walletWebCompanion6441DeploymentAcceptance?.registrySha256 !== "f8a25702bdc7e3bd12b0cdecd6ac513b0a3d3ac25832a112efbe6b788ff8de9b" || audit.walletWebCompanion6441DeploymentAcceptance?.targetPort !== 6441 || audit.walletWebCompanion6441DeploymentAcceptance?.walletAuthTestsPassed !== 326 || audit.walletWebCompanion6441DeploymentAcceptance?.walletAppTestsPassed !== 40) fail("Wallet Web companion 6441 deployment acceptance contract mismatch");
for (const field of ["deployedByCore", "acceptanceExecutedPublic", "gatewayLoadedPublic", "webCompanionVisibleSuccess", "integratedCentral", "aggregatePublic"]) {
  if (audit.walletWebCompanion6441DeploymentAcceptance?.[field] !== false) fail(`walletWebCompanion6441DeploymentAcceptance.${field} must remain false`);
}
