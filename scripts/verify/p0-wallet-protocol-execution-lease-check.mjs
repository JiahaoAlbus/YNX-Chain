...
if (acceptance.integrationVerification?.walletAuthTestsPassed !== 121 || acceptance.integrationVerification?.walletAuthTestsFailed !== 0 || acceptance.integrationVerification?.runtimeSourceTestsPassed !== 119 || acceptance.integrationVerification?.publicEvidenceTestsPassed !== 2 || acceptance.integrationVerification?.focusedTestsPassed !== 4 || acceptance.integrationVerification?.diffCheckPassed !== true || acceptance.integrationVerification?.productionStateCompatibilityPreflightPassed !== true) fail("exact-head verification mismatch");
...
if (installedClientLease.leaseId !== "P0-WALLET-CONNECTIVITY-2026-08-installed-client-computer-control-lease-20260820T101002Z" || installedClientLease.status !== "ISSUED_NOT_EXECUTED" || installedClientLease.prerequisite?.publicRuntimeEvidenceCommit !== "b30775951dcea09bf6b72aeb4806f47ff81b3bef" || installedClientLease.prerequisite?.publicRuntimeSourceCommit !== "49e30d999e9a9cbdd2c565021009f2cab0dc125c") fail("installed-client lease identity mismatch");
...
console.log(`PASS ${acceptance.acceptanceId}: runtime ${acceptance.candidate.candidateRuntimeCommit.slice(0, 12)} public verified, runtime lease closed, installed-client lease P0-WALLET-CONNECTIVITY-2026-08-installed-client-computer-control-lease-20260820T101002Z and Website handoff remain unexecuted`);
