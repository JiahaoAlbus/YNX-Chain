...
for service in ynx-chaind ynx-indexerd ynx-explorerd ynx-faucetd ynx-ai-gatewayd ynx-payd ynx-trustd ynx-resourced caddy nginx; do
...
(ss -lntp 2>/dev/null || netstat -lntp 2>/dev/null || true) | grep -E "(:80|:443|:6420|:6426|:6427|:6428|:6429|:6430|:6431|:6432|:8545|:8546|:26657|:26656|:9090|:1317)\\b" || true

echo "-- config files present"
for path in /etc/caddy/Caddyfile /etc/nginx/conf.d/ynx-chain.conf /etc/nginx/sites-enabled/default /etc/ynx/ynx-chaind.env /etc/ynx/ynx-faucetd.env /etc/ynx/ynx-ai-gatewayd.env /etc/ynx/ynx-payd.env /etc/ynx/ynx-trustd.env /etc/ynx/ynx-resourced.env; do
