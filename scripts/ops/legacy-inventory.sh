...
for service in ynx-chaind ynx-indexerd ynx-explorerd ynx-faucetd ynx-ai-gatewayd caddy nginx; do
...
(ss -lntp 2>/dev/null || netstat -lntp 2>/dev/null || true) | grep -E "(:80|:443|:6420|:6426|:6427|:6428|:6429|:8545|:8546|:26657|:26656|:9090|:1317)\\b" || true

echo "-- config files present"
for path in /etc/caddy/Caddyfile /etc/nginx/conf.d/ynx-chain.conf /etc/nginx/sites-enabled/default /etc/ynx/ynx-chaind.env /etc/ynx/ynx-faucetd.env /etc/ynx/ynx-ai-gatewayd.env; do
