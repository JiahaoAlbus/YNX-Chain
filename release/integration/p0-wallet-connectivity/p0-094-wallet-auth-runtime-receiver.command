sudo -n /usr/bin/env -u YNX_STAGE_TEST_ALLOW_NON_ROOT /usr/bin/node --input-type=module -e 'import { createHash } from "node:crypto";
...
' -- '/var/tmp/ynx-wallet-auth-p0094-dda13e655bdbf033' 'wallet-auth-runtime-dependencies-dda13e65.tar.gz' 'a17794bd15592f3eae1caab34094bc52ec70ce89efa0cbd9995219e94bc7bd86' '707204' '0'
