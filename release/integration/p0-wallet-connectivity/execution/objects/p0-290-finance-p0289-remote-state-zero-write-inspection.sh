...
journal_summary(){
  local body class
  body=$(journalctl --unit ynx-finance.service --since '2026-08-23 18:34:00 UTC' --until '2026-08-23 18:38:02 UTC' --output=cat --no-pager 2>/dev/null || true)
...
printf 'inspection=FINANCE_P0289_REMOTE_STATE_ZERO_WRITE\n'
for spec in \
  leaseParent:/opt/ynx/leases/finance \
  executorPending:/opt/ynx/leases/finance/p0289-finance-phase3-20260824t010000z.executor.sh.pending \
  executor:/opt/ynx/leases/finance/p0289-finance-phase3-20260824t010000z.executor.sh \
  signedLeasePending:/opt/ynx/leases/finance/p0289-finance-phase3-20260824t010000z.json.pending \
  signedLease:/opt/ynx/leases/finance/p0289-finance-phase3-20260824t010000z.json \
  stageParent:/opt/ynx/stage/finance \
  stageContainer:/opt/ynx/stage/finance/p0289-finance-phase3-20260824t010000z \
  stage:/opt/ynx/stage/finance/p0289-finance-phase3-20260824t010000z/stage \
  backupParent:/var/backups/ynx-finance \
  backupContainer:/var/backups/ynx-finance/p0289-finance-phase3-20260824t010000z \
  backup:/var/backups/ynx-finance/p0289-finance-phase3-20260824t010000z/backup \
  releaseParent:/opt/ynx/releases/finance \
  releaseContainer:/opt/ynx/releases/finance/p0289-finance-phase3-20260824t010000z \
  release:/opt/ynx/releases/finance/p0289-finance-phase3-20260824t010000z/ynx-finance-7824af677dd0 \
