...
journal_summary(){
  local body class
  body=$(journalctl --unit ynx-finance.service --since '2026-08-23 19:24:00 UTC' --until '2026-08-23 19:30:00 UTC' --output=cat --no-pager 2>/dev/null || true)
...
printf 'inspection=FINANCE_P0294_REMOTE_STATE_ZERO_WRITE\n'
for spec in \
  leaseParent:/opt/ynx/leases/finance \
  executorPending:/opt/ynx/leases/finance/p0294-finance-phase3-20260824t020000z.executor.sh.pending \
  executor:/opt/ynx/leases/finance/p0294-finance-phase3-20260824t020000z.executor.sh \
  signedLeasePending:/opt/ynx/leases/finance/p0294-finance-phase3-20260824t020000z.json.pending \
  signedLease:/opt/ynx/leases/finance/p0294-finance-phase3-20260824t020000z.json \
  manualRollbackPending:/opt/ynx/leases/finance/p0294-finance-phase3-20260824t020000z.manual-rollback.json.pending \
  manualRollbackLease:/opt/ynx/leases/finance/p0294-finance-phase3-20260824t020000z.manual-rollback.json \
  stageParent:/opt/ynx/stage/finance \
  stageContainer:/opt/ynx/stage/finance/p0294-finance-phase3-20260824t020000z \
  stage:/opt/ynx/stage/finance/p0294-finance-phase3-20260824t020000z/stage \
  backupParent:/var/backups/ynx-finance \
  backupContainer:/var/backups/ynx-finance/p0294-finance-phase3-20260824t020000z \
  backup:/var/backups/ynx-finance/p0294-finance-phase3-20260824t020000z/backup \
  releaseParent:/opt/ynx/releases/finance \
  releaseContainer:/opt/ynx/releases/finance/p0294-finance-phase3-20260824t020000z \
  release:/opt/ynx/releases/finance/p0294-finance-phase3-20260824t020000z/ynx-finance-7824af677dd0 \
