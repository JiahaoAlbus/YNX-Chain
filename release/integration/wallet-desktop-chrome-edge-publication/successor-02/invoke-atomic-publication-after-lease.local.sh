...
relative_root='release/integration/wallet-desktop-chrome-edge-publication/successor-02'
...
test "$(shasum -a 256 "$remote_script" | awk '{print $1}')" = '6a4b8b358fb02b467ff99476635e1fd6ed497b5310718d7827a5c2714e1368ae'
